                    ...
                    <div class="card-body position-relative pt-0 pb-4">
                        <div class="d-sm-flex align-items-end">
                            <div class="profile-avatar-container position-relative mb-3 mb-sm-0 me-4"
                                ...
                                @else
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=fff&color=4e73df&size=150&font-size=0.5"
                                        alt="{{ $user->name }}" class="img-thumbnail rounded-circle shadow"
                                        style="width: 150px; height: 150px; object-fit: cover; border: 4px solid #fff;">
                                @endif
                            </div>
                            <div class="mb-3 mb-sm-0 flex-grow-1 pt-3">
                                <h1 class="h3 text-gray-900 font-weight-bold mb-1">{{ $user->name }}</h1>
                                        ...
                                        <div class="p-3 bg-light rounded-3 border h-100">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="fw-bold text-dark">{{ $user->phone ?? 'Not Provided' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-3 bg-light rounded-3 border h-100">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="fw-bold text-dark">{{ $user->address ?? 'Not Provided' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-3 bg-light rounded-3 border h-100">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="fw-bold text-dark">{{ $user->roles->pluck('name')->map(fn($n) => ucfirst(str_replace('_', ' ', $n)))->join(', ') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="p-3 bg-light rounded-3 border h-100">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="fw-bold text-dark">{{ $user->last_login_at ? $user->last_login_at->format('F d, Y h:i A') : 'Never' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <form method="post" action="{{ route('password.update') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password"
                                                            class="form-control border-start-0 ps-0 @if($errors->updatePassword->has('current_password')) is-invalid @endif"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password"
                                                                class="form-control border-start-0 ps-0 @if($errors->updatePassword->has('password')) is-invalid @endif"
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password"
                                                                class="form-control border-start-0 ps-0 @if($errors->updatePassword->has('password_confirmation')) is-invalid @endif"
