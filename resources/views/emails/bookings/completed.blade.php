...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for choosing <strong>{{ $booking->salon->name ?? 'our salon' }}</strong>! We hope you enjoyed
            ...
            <div class="booking-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $booking->staff->name }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Date & Time:</span>
                    <span class="detail-value">{{ $booking->start_time->format('F j, Y \a\t g:i A') }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Amount:</span>
                    <span class="detail-value">{{ currency_symbol() }}{{ number_format($booking->amount, 2) }}</span>
                </div>
            </div>
            ...
            <div class="rating-section">
                ...
                <p>We'd love to hear your feedback! Your rating helps us improve our services and helps
                    {{ $booking->staff->name }} grow professionally.</p>
            ...
            <p>Best regards,<br>
                <strong>{{ $booking->salon->name ?? 'Salon CMS' }} Team</strong>
            </p>
        </div>

        <div class="footer">
            <p>This is an automated email. Please do not reply directly to this message.</p>
            @if($booking->customer->is_guest)
