...
<div class="modal fade" id="addInventoryModal" tabindex="-1" aria-labelledby="addInventoryModalLabel"
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg" style="background: rgba(255,255,255,0.95); border-radius: 1rem;">
            ...
            <form action="{{ route('admin.inventory.store') }}" method="POST" id="createInventoryForm"
                                ...
                                <div class="col-md-6">
                                    <div class="card border-0 shadow-sm h-100 border-primary"
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <span
                                                    class="input-group-text bg-primary text-white">{{ currency_symbol() }}</span>
                                        ...
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="fw-bold text-white"
                                                    id="profitDisplay">{{ currency_symbol() }}0.00 (0%)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check">
                                                                <input class="form-check-input branch-checkbox" type="checkbox"
                                                                    ...
                                                                    id="branch_create_{{ $branch->id }}" {{ $branch->id == auth()->user()->branch_id ? 'checked' : '' }}>
                                                                <label class="form-check-label small"
                                                                    for="branch_create_{{ $branch->id }}">
                                                                    <i
