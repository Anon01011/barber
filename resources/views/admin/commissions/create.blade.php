...
<div class="container-fluid py-4">
    ...
    <form action="{{ route('admin.commissions.store') }}" method="POST" id="commissionForm">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-check-inline me-4">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_target" value="by_target" {{ old('type') == 'by_target' ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_item" value="by_item" {{ old('type', 'by_item') == 'by_item' ? 'checked' : '' }}>
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-4 mb-3" id="calculationIntervalCol">
                                ...
                                <select class="form-select @error('calculation_interval') is-invalid @enderror" 
                                    ...
                                    <option value="daily" {{ old('calculation_interval') == 'daily' ? 'selected' : '' }}>Daily</option>
                                    <option value="weekly" {{ old('calculation_interval') == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                    <option value="monthly" {{ old('calculation_interval', 'monthly') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                </select>
                            ...
                            <div class="col-md-4 mb-3" id="qualifyingItemCol">
                                ...
                                <select class="form-select @error('qualifying_item') is-invalid @enderror" 
                                    ...
                                    <option value="all" {{ old('qualifying_item', 'all') == 'all' ? 'selected' : '' }}>All Items</option>
                                    <option value="service" {{ old('qualifying_item') == 'service' ? 'selected' : '' }}>Services Only</option>
                                    <option value="product" {{ old('qualifying_item') == 'product' ? 'selected' : '' }}>Products Only</option>
                                    <option value="membership" {{ old('qualifying_item') == 'membership' ? 'selected' : '' }}>Memberships Only</option>
                                    <option value="package" {{ old('qualifying_item') == 'package' ? 'selected' : '' }}>Packages Only</option>
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check mb-2" id="cascadeCol">
                                    <input class="form-check-input" type="checkbox" name="is_cascade" 
                                           id="is_cascade" value="1" {{ old('is_cascade') ? 'checked' : '' }}>
