                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.bookings.calendar') }}" class="btn btn-outline-primary btn-sm">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody id="bookingsTableBody">
                                    @include('admin.bookings.partials.booking_rows', ['bookings' => $bookings])
                                </tbody>
                            </table>
                        </div>
                        <div class="px-4 pt-3">
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.querySelectorAll('.edit-booking').forEach(button => {
                    button.addEventListener('click', function (e) {
                        e.preventDefault();
                        const bookingId = this.getAttribute('data-booking-id');
                        window.location.href = `{{ route('admin.bookings.index') }}?edit_booking_id=${bookingId}`;
                    });
                });
