                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="calendar_default_view">
                                        <option value="timeGridWeek" {{ ($settings['calendar_default_view'] ?? 'timeGridWeek') == 'timeGridWeek' ? 'selected' : '' }}>Week View</option>
                                        <option value="timeGridDay" {{ ($settings['calendar_default_view'] ?? 'timeGridWeek') == 'timeGridDay' ? 'selected' : '' }}>Day View</option>
                                        <option value="resourceTimeGridDay" {{ ($settings['calendar_default_view'] ?? 'timeGridWeek') == 'resourceTimeGridDay' ? 'selected' : '' }}>Staff Day View
                                        </option>
                                    </select>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="guest_booking_enabled"
                                                    value="1" id="guest_booking_enabled" {{ ($settings['guest_booking_enabled'] ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="default_guest_status">
                                                <option value="pending" {{ ($settings['default_guest_status'] ?? 'pending') == 'pending' ? 'selected' : '' }}>Pending</option>
                                                <option value="confirmed" {{ ($settings['default_guest_status'] ?? 'pending') == 'confirmed' ? 'selected' : '' }}>Confirmed</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="slot_duration" class="form-select">
                                                <option value="5" {{ ($settings['slot_duration'] ?? 30) == 5 ? 'selected' : '' }}>5 Minutes</option>
                                                <option value="10" {{ ($settings['slot_duration'] ?? 30) == 10 ? 'selected' : '' }}>10 Minutes</option>
                                                <option value="15" {{ ($settings['slot_duration'] ?? 30) == 15 ? 'selected' : '' }}>15 Minutes</option>
                                                <option value="20" {{ ($settings['slot_duration'] ?? 30) == 20 ? 'selected' : '' }}>20 Minutes</option>
                                                <option value="30" {{ ($settings['slot_duration'] ?? 30) == 30 ? 'selected' : '' }}>30 Minutes</option>
                                                <option value="45" {{ ($settings['slot_duration'] ?? 30) == 45 ? 'selected' : '' }}>45 Minutes</option>
                                                <option value="60" {{ ($settings['slot_duration'] ?? 30) == 60 ? 'selected' : '' }}>60 Minutes</option>
                                            </select>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <select name="appointment_buffer_time" class="form-select">
                                                <option value="0" {{ ($settings['appointment_buffer_time'] ?? 0) == 0 ? 'selected' : '' }}>No Buffer</option>
                                                <option value="5" {{ ($settings['appointment_buffer_time'] ?? 0) == 5 ? 'selected' : '' }}>5 Minutes</option>
                                                <option value="10" {{ ($settings['appointment_buffer_time'] ?? 0) == 10 ? 'selected' : '' }}>10 Minutes</option>
                                                <option value="15" {{ ($settings['appointment_buffer_time'] ?? 0) == 15 ? 'selected' : '' }}>15 Minutes</option>
                                                <option value="20" {{ ($settings['appointment_buffer_time'] ?? 0) == 20 ? 'selected' : '' }}>20 Minutes</option>
                                                <option value="30" {{ ($settings['appointment_buffer_time'] ?? 0) == 30 ? 'selected' : '' }}>30 Minutes</option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="auto_confirm_bookings"
                                                    value="1" id="auto_confirm_bookings" {{ ($settings['auto_confirm_bookings'] ?? false) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="cancellation_policy" class="form-control"
                                                rows="3">{{ $settings['cancellation_policy'] ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-4">
                                                        ...
                                                        <input type="color" class="form-control form-control-color w-100"
                                                            name="booking_color_{{ $status }}"
                                                            value="{{ $settings['booking_color_' . $status] }}"
                                                            title="Background color">
                                                    </div>
                                                    <div class="col-4">
                                                        <label class="form-label small mb-1">Border</label>
                                                        <input type="color" class="form-control form-control-color w-100"
                                                            name="booking_border_{{ $status }}"
                                                            value="{{ $settings['booking_border_' . $status] }}"
                                                            title="Border color">
                                                    </div>
                                                    <div class="col-4">
                                                        <label class="form-label small mb-1">Text</label>
                                                        <input type="color" class="form-control form-control-color w-100"
                                                            name="booking_text_{{ $status }}"
                                                            value="{{ $settings['booking_text_' . $status] }}"
                                                            title="Text color">
                                                    </div>
                                                </div>
                                                <div class="mt-2">
                                                    <div class="preview-badge p-2 rounded border text-center small fw-medium"
                                                        data-status="{{ $status }}"
                                                        style="background-color: {{ $settings['booking_color_' . $status] }}; 
                                                                                                border-color: {{ $settings['booking_border_' . $status] }} !important; 
                                                                                                color: {{ $settings['booking_text_' . $status] }};">
