...
@section('content')
    <div class="container-fluid py-4">
        ...
        <form action="{{ route('admin.packages.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="row g-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg bg-light border-0" id="name"
                                    name="name" value="{{ old('name') }}" placeholder="e.g., Summer Glow Package" required>
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="form-check custom-card-radio flex-fill">
                                            <input class="form-check-input" type="radio" name="type" id="customizable"
                                                value="customizable" {{ old('type') == 'customizable' ? 'checked' : '' }}
                                                required>
                                            <label
                                                class="form-check-label p-3 border rounded-3 w-100 d-flex align-items-center cursor-pointer transition-all"
                                                for="customizable">
                            ...
                            <div class="mb-4" id="service_limit_container" style="display: none;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg bg-light border-0"
                                        id="service_limit" name="service_limit" value="{{ old('service_limit') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-lg bg-light border-0"
                                            ...
                                            value="{{ old('validity_value', 30) }}" min="1" required>
                                        <select class="form-select form-select-lg bg-light border-0" id="validity_unit"
                                            name="validity_unit" style="max-width: 120px;">
                                            <option value="days" {{ old('validity_unit') == 'days' ? 'selected' : '' }}>Days
                                            </option>
                                            <option value="weeks" {{ old('validity_unit') == 'weeks' ? 'selected' : '' }}>
                                                Weeks</option>
                                            <option value="months" {{ old('validity_unit') == 'months' ? 'selected' : '' }}>
                                                Months</option>
                                            <option value="years" {{ old('validity_unit') == 'years' ? 'selected' : '' }}>
                                                Years</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border-0 bg-light" id="tax_rate" name="tax_rate" required>
                                        ...
                                        @foreach($taxRates as $rate)
                                            <option value="{{ $rate }}" {{ old('tax_rate') == $rate ? 'selected' : '' }}>
                                                {{ $rate }}%
                                            </option>
                                        @endforeach
                                    </select>
