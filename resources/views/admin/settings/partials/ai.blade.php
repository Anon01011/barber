    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_insights" name="enable_ai_insights" value="1" {{ old('enable_ai_insights', $settings['enable_ai_insights'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_visual_consultation" name="enable_ai_visual_consultation" value="1" {{ old('enable_ai_visual_consultation', $settings['enable_ai_visual_consultation'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_noshow_prevention" name="enable_ai_noshow_prevention" value="1" {{ old('enable_ai_noshow_prevention', $settings['enable_ai_noshow_prevention'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_marketing_generator" name="enable_ai_marketing_generator" value="1" {{ old('enable_ai_marketing_generator', $settings['enable_ai_marketing_generator'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_whatsapp_assistant" name="enable_ai_whatsapp_assistant" value="1" {{ old('enable_ai_whatsapp_assistant', $settings['enable_ai_whatsapp_assistant'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_churn_auto_marketing" name="enable_ai_churn_auto_marketing" value="1" {{ old('enable_ai_churn_auto_marketing', $settings['enable_ai_churn_auto_marketing'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" name="ai_churn_discount_percentage" value="{{ old('ai_churn_discount_percentage', $settings['ai_churn_discount_percentage'] ?? 15) }}" min="5" max="50">
            </div>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_inventory_alerts" name="enable_ai_inventory_alerts" value="1" {{ old('enable_ai_inventory_alerts', $settings['enable_ai_inventory_alerts'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_dynamic_yield_pricing" name="enable_ai_dynamic_yield_pricing" value="1" {{ old('enable_ai_dynamic_yield_pricing', $settings['enable_ai_dynamic_yield_pricing'] ?? true) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-check form-switch card p-3 border-0 bg-light">
                <input class="form-check-input ms-0 me-3" type="checkbox" id="enable_ai_floating_widget" name="enable_ai_floating_widget" value="1" {{ old('enable_ai_floating_widget', $settings['enable_ai_floating_widget'] ?? true) ? 'checked' : '' }}>
