                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-0">
                        ...
                        <div id="step-1" class="setup-step p-4 p-md-5"
                            x-data="{ gateway: '{{ $settings['whatsapp_gateway'] ?? 'twilio' }}' }">
                                    ...
                                    <div class="gateway-fields p-3 bg-light rounded border mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="wizard_whatsapp_custom_headers"
                                                ...
                                                placeholder='{"Authorization": "Bearer ...", "Content-Type": "application/json"}'>{{ $settings['whatsapp_custom_headers'] ?? '' }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold small">Additional Payload (JSON)</label>
                                            <textarea id="wizard_whatsapp_custom_payload"
                                                class="form-control form-control-sm" rows="2"
                                                placeholder='{"instance_id": "123", "access_token": "abc"}'>{{ $settings['whatsapp_custom_payload'] ?? '' }}</textarea>
                                        </div>
                                    </div>
                                </template>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.getElementById('btn-test-whatsapp').addEventListener('click', async function () {
                    ...
                    try {
                        const res = await fetch('{{ route('admin.settings.whatsapp-setup.test') }}', {
                            method: 'POST',
