                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="secondary_country_code"
                                                value="{{ old('secondary_country_code', '+91') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select @error('preferred_contact') is-invalid @enderror"
                                                    ...
                                                    <option value="phone" {{ old('preferred_contact', 'phone') == 'phone' ? 'selected' : '' }}>Phone</option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select @error('source') is-invalid @enderror"
                                                    ...
                                                    <option value="online" {{ old('source') == 'online' ? 'selected' : '' }}>
                                                        Online</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_promotional_sms"
                                                    name="send_promotional_sms" value="1" {{ old('send_promotional_sms', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_transactional_sms"
                                                    name="send_transactional_sms" value="1" {{ old('send_transactional_sms', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control @error('medical_notes') is-invalid @enderror"
                                                    ...
                                                    placeholder="Any allergies, medical conditions, or special requirements...">{{ old('medical_notes') }}</textarea>
                                                @error('medical_notes')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
