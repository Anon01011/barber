            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm segment-card active" data-segment=""
                        ...
                        <div class="card-body text-center py-4">
                            <h2 class="display-4 fw-bold mb-1" style="color: #333;">{{ $counts['total'] ?? 0 }}</h2>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm segment-card" data-segment="active"
                        ...
                        <div class="card-body text-center py-4">
                            <h2 class="display-4 fw-bold mb-1" style="color: #333;">{{ $counts['active'] ?? 0 }}</h2>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm segment-card" data-segment="churn"
                        ...
                        <div class="card-body text-center py-4">
                            <h2 class="display-4 fw-bold mb-1" style="color: #333;">{{ $counts['churn'] ?? 0 }}</h2>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card h-100 border-0 shadow-sm segment-card" data-segment="defected"
                        ...
                        <div class="card-body text-center py-4">
                            <h2 class="display-4 fw-bold mb-1" style="color: #333;">{{ $counts['defected'] ?? 0 }}</h2>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <a href="{{ route('admin.customers.import-template') }}" class="alert-link">Download template</a>
                    </div>
...
<script>
    ...
    function initializeEventListeners() {
        ...
        document.getElementById('importCustomerForm').addEventListener('submit', function (e) {
            ...
            fetch('{{ route("admin.customers.import") }}', {
                method: 'POST',
                headers: {
    ...
    `;
        ...
        const url = new URL('{{ route("admin.customers.index") }}', window.location.origin);
    ...
    function deleteCustomer() {
        ...
        fetch(`{{ route('admin.customers.index') }}/${customerToDelete}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'Accept': 'application/json',
            ...
            <div class="modal-body p-4">
                ...
                <div id="receiptServices">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span>{{ currency_symbol() }}35.00</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <div>
                        ...
                        <span>{{ currency_symbol() }}85.00</span>
                    </div>
                </div>
                ...
                <div class="mt-4 pt-3 border-top">
                    <div class="d-flex justify-content-between mb-2">
                        <span>Subtotal:</span>
                        <span>{{ currency_symbol() }}120.00</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Tax (10%):</span>
                        <span>{{ currency_symbol() }}12.00</span>
                    </div>
                    <div class="d-flex justify-content-between fw-bold fs-5 mt-3">
                        <span>Total:</span>
                        <span>{{ currency_symbol() }}132.00</span>
                    </div>
                </div>
