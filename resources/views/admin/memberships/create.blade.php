...
@section('title', 'Add Discount Membership')
@section('content')
                ...
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-3">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb small mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.memberships.index') }}">Memberships</a>
                            </li>
                        ...
                        <div class="card-body">
                            <div class="row g-3 mb-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" name="name" value="{{ old('name') }}" placeholder="E.g. Salon VIP"
                                        required>
                                    @error('name')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="1"
                                            class="form-control @if($errors->has('discount_value')) is-invalid @endif"
                                            id="discount_value" name="discount_value"
                                            value="{{ is_array(old('discount_value')) ? '' : old('discount_value', '') }}"
                                ...
                                <div class="col-md-4">
                                    <label for="is_taxable" class="form-label fw-semibold">Tax <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select @error('is_taxable') is-invalid @enderror" id="is_taxable"
                                        name="is_taxable" required>
                                        <option value="0" {{ old('is_taxable', 0) == 0 ? 'selected' : '' }}>Not Applicable
                                        </option>
                                        <option value="1" {{ old('is_taxable') == 1 ? 'selected' : '' }}>Taxable</option>
                                    </select>
                                    @error('is_taxable')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <label for="validity_value" class="form-label fw-semibold">Validity Duration <span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control @error('validity_value') is-invalid @enderror"
                                        id="validity_value" name="validity_value" value="{{ old('validity_value', 30) }}"
                                ...
                                <div class="col-md-6">
                                    <label for="validity_unit" class="form-label fw-semibold">Validity Unit <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select @error('validity_unit') is-invalid @enderror"
                                        id="validity_unit" name="validity_unit" required>
                                        <option value="days" {{ old('validity_unit', 'days') == 'days' ? 'selected' : '' }}>
                                            Days</option>
                                        <option value="weeks" {{ old('validity_unit') == 'weeks' ? 'selected' : '' }}>Weeks
                                        </option>
                                        <option value="months" {{ old('validity_unit') == 'months' ? 'selected' : '' }}>Months
                                        </option>
                                        <option value="years" {{ old('validity_unit') == 'years' ? 'selected' : '' }}>Years
                                        </option>
                                    </select>
                                    @error('validity_unit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mt-4 pt-1">
                                        <input class="form-check-input @error('is_active') is-invalid @enderror"
                                            type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                    ...
                                    placeholder="Describe the membership">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-all" value="all" {{ old('membership_type', 'all') == 'all' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-services" value="services" {{ old('membership_type') == 'services' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-products" value="products" {{ old('membership_type') == 'products' ? 'checked' : '' }}>
                                                ...
                                                @foreach($services as $service)
                                                    <div class="form-check service-item"
                                                        ...
                                                        <label class="form-check-label" for="service-{{ $service->id }}">
                                                            {{ $service->name }} - {{ $globalSettings['currency_symbol'] }}
                                                ...
                                                @foreach($products as $product)
                                                    <div class="form-check product-item"
                                                        ...
                                                        <label class="form-check-label" for="product-{{ $product->id }}">
                                                            {{ $product->name }} - {{ $globalSettings['currency_symbol'] }}
                    ...
                    <div class="card mt-4 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('admin.memberships.index') }}" class="btn btn-outline-secondary"><i
