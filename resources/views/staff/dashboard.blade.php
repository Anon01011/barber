                ...
                <div class="card border-0 shadow-sm bg-gradient-primary text-white overflow-hidden position-relative">
                    <div class="card-body p-5 position-relative z-index-2">
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <h2 class="display-6 fw-bold mb-2">Welcome back, {{ Auth::user()->name }}! 👋</h2>
                ...
                <div class="card border-0 shadow-sm h-100 transition-hover">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-end justify-content-between">
                            <h2 class="mb-0 fw-bold text-dark">{{ $todayAppointmentsCount ?? 0 }}</h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 transition-hover">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-end justify-content-between">
                            <h2 class="mb-0 fw-bold text-dark">{{ $upcomingAppointmentsCount ?? 0 }}</h2>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0 pb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 transition-hover">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-end justify-content-between">
                            <h2 class="mb-0 fw-bold text-dark">{{ $completedAppointmentsCount ?? 0 }}</h2>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-end justify-content-between">
                            <h2 class="mb-0 fw-bold text-dark">
                                {{ currency_symbol() }}{{ number_format($totalRevenue ?? 0, 2) }}
                            </h2>
                        </div>
                    </div>
                    <!-- <div class="card-footer bg-transparent border-0 pt-0 pb-4">
                                    ...
                                    @forelse($todayAppointments as $appointment)
                                        <tr>
                                            <td class="px-4 py-3 text-nowrap" style="width: 120px;">
                                                <span
                                                    class="fw-bold text-dark h6 mb-0">{{ $appointment->start_time->format('h:i A') }}</span>
                                            </td>
                                            <td class="py-3">
                                                <div class="d-flex align-items-center">
                                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($appointment->customer->name) }}&background=random&size=40"
                                            ...
                                            <td class="py-3">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-muted text-xs"><i
                                                            class="far fa-clock me-1"></i>{{ $appointment->service->duration }}
                                                        mins</span>
                                                </div>
                                            </td>
