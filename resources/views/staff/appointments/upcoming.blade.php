            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body p-3">
                        <form
                            action="{{ route('employee.appointments.upcoming', ['salon_slug' => optional(auth()->user()->salon)->slug]) }}"
                                    ...
                                    <tbody>
                                        @foreach($appointments as $appointment)
                                            <tr>
                                                ...
                                                <td class="py-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            @if($appointment->customer->is_guest)
                                                ...
                                                <td class="py-3">
                                                    <span
                                                        class="badge bg-{{ $appointment->status === 'confirmed' ? 'success' : 'warning' }}-subtle text-{{ $appointment->status === 'confirmed' ? 'success' : 'warning' }} border border-{{ $appointment->status === 'confirmed' ? 'success' : 'warning' }}-subtle rounded-pill">
                                                ...
                                                <td class="py-3 text-end px-4">
                                                    <div class="btn-group">
                                                        ...
                                                        @if($appointment->status === 'pending' && $appointment->staff_assignment_status === 'pending')
                                                            <button class="btn btn-sm btn-light text-success hover-shadow ms-1"
                                                                onclick="checkAndAcceptAppointment({{ $appointment->id }})"
                                                                title="Accept">
                                                                <i class="fas fa-check"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-light text-danger hover-shadow ms-1"
                                                                onclick="rejectAppointment({{ $appointment->id }})" title="Reject">
                                                                <i class="fas fa-times"></i>
                                                            </button>
                                                        @elseif($appointment->status === 'confirmed')
                                                            <button class="btn btn-sm btn-light text-success hover-shadow ms-1"
                                                                onclick="completeAppointment({{ $appointment->id }})" title="Complete">
