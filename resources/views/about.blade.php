        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto">
                <h1 class="text-4xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6 tracking-tight">
                    The Story Behind <span class="gradient-text">{{ $appName }}</span>
                </h1>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-slate-400 text-lg mb-8">
                        {{ $appName }} isn't just a booking tool. It's a complete operating system designed to scale with your business, whether you have one chair or a hundred locations.
                    </p>
                    <div class="space-y-4">
