        ...
        <form action="{{ route('admin.notifications.store') }}" method="POST">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.notifications.index') }}" class="btn btn-white border shadow-sm fw-medium text-muted">
                            Discard
                        </a>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg bg-light border-0" id="title" name="title"
                                        value="{{ old('title') }}" placeholder="Enter a catchy headline..." required onkeyup="updatePreview()">
                                    @error('title')
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea class="form-control" id="message" name="message" rows="12">{{ old('message') }}</textarea>
                                    @error('message')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
