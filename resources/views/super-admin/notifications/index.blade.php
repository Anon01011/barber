...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('admin.notifications.create') }}" class="btn btn-primary shadow-sm fw-medium">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($notifications as $notification)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge {{ $badgeClass }} border px-3 py-2 rounded-pill">
                                            <i class="{{ $icon }} me-1"></i> {{ ucfirst($notification->type) }}
                                        </span>
                                    </td>
                                    <td>
                                        @if($notification->target_salon_id)
                                            <div class="d-flex align-items-center text-dark">
                                                ...
                                                <div>
                                                    <div class="fw-medium small">{{ $notification->salon->name }}</div>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.notifications.toggle', $notification) }}" method="POST">
                                            ...
                                            @method('PATCH')
                                            <button type="submit"
                                                class="btn btn-sm {{ $notification->is_active ? 'btn-outline-success' : 'btn-outline-secondary' }} rounded-pill px-3"
                                                title="Toggle Status">
                                    ...
                                    <td class="pe-4 text-end">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-light border" data-bs-toggle="modal"
                                                data-bs-target="#viewModal{{ $notification->id }}" title="View Details">
                                ...
                                <!-- View Modal -->
                                <div class="modal fade" id="viewModal{{ $notification->id }}" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-header border-bottom-0 pb-0">
                                                <h5 class="modal-title fw-bold text-gray-800">{{ $notification->title }}</h5>
                                            ...
                                            <div class="modal-body pt-3">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center text-muted small">
                                                    <div>
                                                        ...
                                                        Target:
                                                        <strong>{{ $notification->target_salon_id ? $notification->salon->name : 'All Salons' }}</strong>
                                                    </div>
                                                    <div>
