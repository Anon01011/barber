...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="h3 mb-1 fw-bold text-gray-900">Edit Plan: {{ $plan->name }}</h1>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="business_type" class="form-select form-select-lg @error('business_type') is-invalid @enderror" required>
                                                <option value="both" {{ old('business_type', $plan->business_type) == 'both' ? 'selected' : '' }}>Both (Salon & Barber)</option>
                                                <option value="salon" {{ old('business_type', $plan->business_type) == 'salon' ? 'selected' : '' }}>Salon Only</option>
                                                <option value="barber" {{ old('business_type', $plan->business_type) == 'barber' ? 'selected' : '' }}>Barber Only</option>
                                            </select>
                                            @error('business_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('trial_days', $plan->trial_days) }}" placeholder="14">
                                            </div>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" id="is_active"
                                                        name="is_active" {{ old('is_active', $plan->is_active) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" id="is_popular"
                                                        name="is_popular" {{ old('is_popular', $plan->is_popular) ? 'checked' : '' }}>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-3" id="container_max_users">
                                            ...
                                            <input type="number" class="form-control" id="max_users" name="max_users"
                                                value="{{ old('max_users', $plan->max_users > 0 ? $plan->max_users : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_branches">
                                            ...
                                            <input type="number" class="form-control" id="max_branches" name="max_branches"
                                                value="{{ old('max_branches', $plan->max_branches > 0 ? $plan->max_branches : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_customers">
                                            ...
                                            <input type="number" class="form-control" id="max_customers"
                                                ...
                                                value="{{ old('limits.max_customers', isset($plan->limits['max_customers']) && $plan->limits['max_customers'] > 0 ? $plan->limits['max_customers'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_services">
                                            ...
                                            <input type="number" class="form-control" id="max_services"
                                                ...
                                                value="{{ old('limits.max_services', isset($plan->limits['max_services']) && $plan->limits['max_services'] > 0 ? $plan->limits['max_services'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_products">
                                            ...
                                            <input type="number" class="form-control" id="max_products"
                                                ...
                                                value="{{ old('limits.max_products', isset($plan->limits['max_products']) && $plan->limits['max_products'] > 0 ? $plan->limits['max_products'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_packages">
                                            ...
                                            <input type="number" class="form-control" id="max_packages"
                                                ...
                                                value="{{ old('limits.max_packages', isset($plan->limits['max_packages']) && $plan->limits['max_packages'] > 0 ? $plan->limits['max_packages'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_memberships">
                                            ...
                                            <input type="number" class="form-control" id="max_memberships"
                                                ...
                                                value="{{ old('limits.max_memberships', isset($plan->limits['max_memberships']) && $plan->limits['max_memberships'] > 0 ? $plan->limits['max_memberships'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_bookings_per_month">
                                            ...
                                            <input type="number" class="form-control" id="max_bookings_per_month"
                                                ...
                                                value="{{ old('limits.max_bookings_per_month', isset($plan->limits['max_bookings_per_month']) && $plan->limits['max_bookings_per_month'] > 0 ? $plan->limits['max_bookings_per_month'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_guest_bookings_per_month">
                                            ...
                                            <input type="number" class="form-control" id="max_guest_bookings_per_month"
                                                ...
                                                value="{{ old('limits.max_guest_bookings_per_month', isset($plan->limits['max_guest_bookings_per_month']) && $plan->limits['max_guest_bookings_per_month'] > 0 ? $plan->limits['max_guest_bookings_per_month'] : '') }}"
                                                placeholder="∞">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm bg-light mb-4">
                        <div class="card-body">
                            ...
                            <p class="mb-2"><strong>Active Subscriptions:</strong> {{ $plan->subscriptions()->count() }}</p>
                            <p class="mb-2"><strong>Created:</strong> {{ $plan->created_at->format('M d, Y') }}</p>
    ...
    @push('scripts')
        <script>
            ...
            let features = [];
            try {
                const planFeatures = @json($plan->features ?? []);
