...
@section('content')
    <div class="container-fluid px-4 py-4">
        <form action="{{ route('admin.pos.sales.update', $sale->id) }}" method="POST" id="edit-sale-form">
            @csrf
            @method('PUT')
                        ...
                        <div class="card-header bg-white border-bottom-0 py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="badge bg-primary-soft text-primary px-3 py-2">
                                    <i class="fas fa-receipt me-1"></i> #{{ $sale->invoice_number }}
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('invoice_number') is-invalid @enderror"
                                        ...
                                        value="{{ old('invoice_number', $sale->invoice_number) }}" readonly required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local"
                                        ...
                                        name="sale_date"
                                        value="{{ old('sale_date', $sale->sale_date ? $sale->sale_date->format('Y-m-d\TH:i') : ($sale->created_at ? $sale->created_at->format('Y-m-d\TH:i') : '')) }}"
                                        required>
                                    @error('sale_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('employee_id') is-invalid @enderror" id="employee_id"
                                        ...
                                        @foreach($employees as $employee)
                                            <option value="{{ $employee->id }}" {{ old('employee_id', $sale->employee_id) == $employee->id ? 'selected' : '' }}>
                                                {{ $employee->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('payment_method') is-invalid @enderror"
                                        ...
                                        <option value="none" {{ old('payment_method', $sale->payment_method) == 'none' ? 'selected' : '' }}
                                            @if($hasFutureBooking) disabled title="Not allowed for future appointments" @endif>
                                            Pay Later @if($hasFutureBooking) (Not allowed for future appointments) @endif
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-3 mb-3 payment-col" data-method="cash">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control payment-input" id="cash_amount"
                                            name="cash_amount" value="{{ old('cash_amount', $sale->cash_amount) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3 payment-col" data-method="card">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control payment-input" id="card_amount"
                                            name="card_amount" value="{{ old('card_amount', $sale->card_amount) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3 payment-col" data-method="online">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control payment-input"
                                            ...
                                            value="{{ old('online_amount', $sale->online_amount) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3 payment-col" data-method="other">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control payment-input"
                                            ...
                                            value="{{ old('other_amount', $sale->other_amount) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01"
                                            class="form-control @error('tendered_amount') is-invalid @enderror"
                                            id="tendered_amount" name="tendered_amount"
                                            value="{{ old('tendered_amount', $sale->tendered_amount) }}">
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01"
                                            class="form-control @error('change_amount') is-invalid @enderror"
                                            id="change_amount" name="change_amount"
                                            value="{{ old('change_amount', $sale->change_amount) }}">
                                    </div>
                                    @error('change_amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes"
                                    rows="3"
                                    placeholder="Add any internal notes here...">{{ old('notes', $sale->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                                ...
                                                <td class="ps-4 py-3">
                                                    ...
                                                    @if($item->staff)
                                                        <small class="text-muted"><i
                                                                class="fas fa-user-tag me-1"></i>{{ $item->staff->name }}</small>
                                                    @endif
                                                </td>
                                                <td class="py-3">{{ format_currency($item->unit_price) }}</td>
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="discount" value="{{ old('discount', $sale->discount) }}">
                                </div>
                                @error('discount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('tip') is-invalid @enderror"
                                        id="tip" name="tip" value="{{ old('tip', $sale->tip) }}">
                                </div>
                                @error('tip')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="summary-card">
                                <div class="summary-row">
                                    <span>Subtotal</span>
                                    <span class="fw-bold">{{ format_currency($sale->subtotal) }}</span>
                                </div>
                                <div class="summary-row text-danger">
                                    <span>Discount</span>
                                    <span class="fw-bold"
                                        id="summary-discount">-{{ format_currency($sale->discount) }}</span>
                                </div>
                                <div class="summary-row">
                                    <span>Tax</span>
                                    <span class="fw-bold">{{ format_currency($sale->tax) }}</span>
                                </div>
                                <div class="summary-row text-success">
                                    <span>Tip</span>
                                    <span class="fw-bold" id="summary-tip">{{ format_currency($sale->tip) }}</span>
                                </div>
                                <div class="summary-row total">
                                    <span>Total</span>
                                    <span id="summary-total">{{ format_currency($sale->total) }}</span>
                                </div>
                                <div class="summary-row mt-2 pt-2 border-top">
                                    <span>Paid</span>
                                    <span class="fw-bold text-success"
                                        id="summary-paid">{{ format_currency($sale->total - $sale->outstanding_amount) }}</span>
                                </div>
                                <div class="summary-row">
                                    <span>Outstanding</span>
                                    <span class="fw-bold text-danger"
                                        id="summary-outstanding">{{ format_currency($sale->outstanding_amount) }}</span>
                                </div>
                            </div>
