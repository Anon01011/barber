...
<head>
    ...
    <title>Rate Your Experience - {{ $booking->salon->name ?? 'Salon CMS' }}</title>
                        ...
                        @if(isset($booking))
                            <div class="booking-info mt-4">
                                ...
                                <div class="info-row">
                                    ...
                                    <span class="info-value">{{ $booking->staff->name }}</span>
                                </div>
                                <div class="info-row">
                                    <span class="info-label">Date:</span>
                                    <span class="info-value">{{ $booking->start_time->format('F j, Y') }}</span>
                                </div>
                            </div>
                        @endif
                    </div>
                @else
                    <div class="booking-info">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $booking->start_time->format('F j, Y \a\t g:i A') }}</span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Salon:</span>
                            <span class="info-value">{{ $booking->salon->name ?? 'N/A' }}</span>
                        </div>
                    </div>
                    ...
                    <form id="ratingForm">
                        ...
                        <div class="comment-section">
                            ...
                            <textarea class="form-control" id="comment" name="comment" rows="4"
                                placeholder="Tell us about your experience with {{ $booking->staff->name }}..."
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                // Submit via AJAX
                fetch('{{ route("ratings.guest.submit", ["token" => $token ?? ""]) }}', {
                    method: 'POST',
                    headers: {
