...
<head>
    ...
    <title>{{ app(\App\Services\SettingsService::class)->get('app_name', config('app.name', 'Laravel')) }} - Super Admin
    </title>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <div class="sidebar-brand">
                    ...
                    @endphp
                    <img src="{{ $logoUrl }}" alt="Logo" class="sidebar-brand-logo me-2" style="height: 28px; width: 28px;">
                    <span
                        class="sidebar-brand-text">{{ app(\App\Services\SettingsService::class)->get('app_name', config('app.name', 'SaaS Admin')) }}</span>
                </div>
            ...
            <div class="sidebar-menu">
                ...
                <a href="{{ route('admin.super.dashboard') }}"
                    class="sidebar-item {{ request()->routeIs('admin.super.dashboard') ? 'active' : '' }}">
                ...
                <div class="sidebar-section">
                    <a href="#" class="sidebar-item {{ request()->routeIs('admin.saas.reports.*') ? 'active' : '' }}"
                        data-bs-toggle="collapse" data-bs-target="#reportsSubmenu"
                        aria-expanded="{{ request()->routeIs('admin.saas.reports.*') ? 'true' : 'false' }}">
                        <i class="fas fa-chart-bar sidebar-icon"></i>
                        <span class="sidebar-text">Reports</span>
                        <i
                            class="fas fa-chevron-{{ request()->routeIs('admin.saas.reports.*') ? 'up' : 'down' }} ms-auto chevron"></i>
                    </a>
                    <div class="collapse {{ request()->routeIs('admin.saas.reports.*') ? 'show' : '' }}"
                        id="reportsSubmenu">
                        <div class="px-4 py-1">
                            <a href="{{ route('admin.saas.reports.index') }}"
                                class="sidebar-item sub-item {{ request()->routeIs('admin.saas.reports.index') ? 'active' : '' }}">
                                <i class="fas fa-tachometer-alt sidebar-icon"></i>
                                <span class="sidebar-text">Overview</span>
                            </a>
                            <a href="{{ route('admin.saas.reports.revenue') }}"
                                class="sidebar-item sub-item {{ request()->routeIs('admin.saas.reports.revenue') ? 'active' : '' }}">
                                <i class="fas fa-dollar-sign sidebar-icon"></i>
                                <span class="sidebar-text">Revenue</span>
                            </a>
                            <a href="{{ route('admin.saas.reports.subscriptions') }}"
                                class="sidebar-item sub-item {{ request()->routeIs('admin.saas.reports.subscriptions') ? 'active' : '' }}">
                                <i class="fas fa-file-contract sidebar-icon"></i>
                                <span class="sidebar-text">Subscriptions</span>
                            </a>
                        </div>
                ...
                <a href="{{ route('admin.notifications.index') }}"
                    class="sidebar-item {{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.email-templates.index') }}"
                    class="sidebar-item {{ request()->routeIs('admin.email-templates.*') ? 'active' : '' }}">
                    ...
                    <div class="user-dropdown">
                        <div class="user-dropdown-toggle" id="userDropdownToggle">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=random"
                                alt="{{ auth()->user()->name }}" class="rounded-circle me-2" style="width: 32px; height: 32px;">
