...
<head>
    ...
    <title>Subscription Paused - {{ config('app.name') }}</title>
        ...
        <div class="auth-right">
            <div class="auth-card">
                ...
                <div
                    ...
                    {{ session('error') ?? 'Access to your dashboard is temporarily restricted. Please contact support for more information.' }}
                </div>

                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    <a href="mailto:{{ config('mail.from.address') }}" class="auth-button"
