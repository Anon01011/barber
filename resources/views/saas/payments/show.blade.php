    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Transaction #{{ $payment->transaction_id }}</p>
            </div>
            <a href="{{ route('admin.saas.payment.history') }}" class="btn btn-outline-primary">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-semibold">
                                    <span class="badge bg-secondary px-3 py-2">
                                        <i class="fas fa-credit-card me-1"></i>{{ ucfirst($payment->payment_method) }}
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            @if($payment->paid_at)
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-semibold">
                                        {{ $payment->paid_at->format('F d, Y \a\t h:i A') }}
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-semibold">
                                        <span class="badge bg-primary px-3 py-2">{{ $payment->subscription->plan->name }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small mb-1">Plan Price</label>
                                    <div class="fw-semibold">
                                        {{ system_format_currency($payment->subscription->plan->price) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small mb-1">Subscription Period</label>
                                    <div class="fw-semibold">
                                        {{ $payment->subscription->starts_at->format('M d, Y') }} -
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fw-semibold">
                                        {{ $payment->subscription->plan->duration_in_days }} days
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            @if($payment->subscription_id)
                                ...
                                <a href="{{ route('admin.invoices.download', $payment->id) }}"
                            ...
                            <a href="{{ route('admin.saas.subscription.index') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <div class="small text-muted">{{ $payment->created_at->format('M d, Y h:i A') }}</div>
                            ...
                            @if($payment->paid_at)
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        <div class="small text-muted">{{ $payment->paid_at->format('M d, Y h:i A') }}</div>
