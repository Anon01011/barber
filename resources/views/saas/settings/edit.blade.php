    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @if(auth()->user()->hasRole('salon_admin'))
                <div>
                    <form action="{{ route('admin.saas.settings.clear-cache') }}" method="POST" class="d-inline">
                        @csrf
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <ul class="nav nav-tabs card-header-tabs" id="settingsTabs" role="tablist">
                    ...
                    @if(auth()->user()->hasAnyRole(['salon_admin', 'manager']))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.saas.settings.mail') }}">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.saas.settings.update') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
