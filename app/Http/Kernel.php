...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\SanitizeInputs::class, // Sanitize all incoming query and body inputs against XSS
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\RefreshPermissionCache::class, // Refresh permission cache periodically
        ],
    ...
    protected $middlewareAliases = [
        ...
        'plan_limits' => \App\Http\Middleware\CheckPlanLimits::class,
