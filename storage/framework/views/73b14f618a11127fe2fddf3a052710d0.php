...
unset($__errorArgs, $__bag); ?>"
                                                id="slug" name="slug" value="<?php echo e(old('slug')); ?>" placeholder="premium-plan"
                                                required>
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                <option value="salon" <?php echo e(old('business_type') == 'salon' ? 'selected' : ''); ?>>Salon Only</option>
                                                <option value="barber" <?php echo e(old('business_type') == 'barber' ? 'selected' : ''); ?>>Barber Only</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('duration_in_days', 30)); ?>" placeholder="30" required>
                                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                                    id="trial_days" name="trial_days" value="<?php echo e(old('trial_days', 14)); ?>"
                                                    placeholder="14">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3"
                                                placeholder="Brief description of this plan"><?php echo e(old('description')); ?></textarea>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-3" id="container_max_users">
                                            ...
                                            <input type="number" class="form-control" id="max_users" name="max_users"
                                                value="<?php echo e(old('max_users')); ?>" placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_branches">
                                            ...
                                            <input type="number" class="form-control" id="max_branches" name="max_branches"
                                                value="<?php echo e(old('max_branches')); ?>" placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_customers">
                                            ...
                                            <input type="number" class="form-control" id="max_customers"
                                                name="limits[max_customers]" value="<?php echo e(old('limits.max_customers')); ?>"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_services">
                                            ...
                                            <input type="number" class="form-control" id="max_services"
                                                name="limits[max_services]" value="<?php echo e(old('limits.max_services')); ?>"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_products">
                                            ...
                                            <input type="number" class="form-control" id="max_products"
                                                name="limits[max_products]" value="<?php echo e(old('limits.max_products')); ?>"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_packages">
                                            ...
                                            <input type="number" class="form-control" id="max_packages"
                                                name="limits[max_packages]" value="<?php echo e(old('limits.max_packages')); ?>"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_memberships">
                                            ...
                                            <input type="number" class="form-control" id="max_memberships"
                                                name="limits[max_memberships]" value="<?php echo e(old('limits.max_memberships')); ?>"
                                                placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_bookings_per_month">
                                            ...
                                            <input type="number" class="form-control" id="max_bookings_per_month"
                                                ...
                                                value="<?php echo e(old('limits.max_bookings_per_month')); ?>" placeholder="∞">
                                        </div>
                                        ...
                                        <div class="col-md-3" id="container_max_guest_bookings_per_month">
                                            ...
                                            <input type="number" class="form-control" id="max_guest_bookings_per_month"
                                                ...
                                                value="<?php echo e(old('limits.max_guest_bookings_per_month')); ?>" placeholder="∞">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\super-admin\plans\create.blade.php ENDPATH**/ ?>