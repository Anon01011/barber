    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (ratingForm) {
            ratingForm.addEventListener('submit', function (e) {
                ...
                // Submit via AJAX
                fetch(`/<?php echo e($salon_slug ?? ''); ?>/customer/appointments/${bookingId}/rate`, {
                    method: 'POST',
                    headers: {
...
</script><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\partials\rating-modal.blade.php ENDPATH**/ ?>