...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-percent text-primary me-2"></i>Create Commission Profile
            </h1>
            <p class="text-muted mb-0">Set up commission structures by target slab or individual items</p>
        </div>
    ...
    <form action="<?php echo e(route('admin.commissions.store')); ?>" method="POST" id="commissionForm">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-check-inline me-4">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_target" value="by_target" <?php echo e(old('type') == 'by_target' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_item" value="by_item" <?php echo e(old('type', 'by_item') == 'by_item' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3" id="calculationIntervalCol">
                                ...
                                <select class="form-select <?php $__errorArgs = ['calculation_interval'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="daily" <?php echo e(old('calculation_interval') == 'daily' ? 'selected' : ''); ?>>Daily</option>
                                    <option value="weekly" <?php echo e(old('calculation_interval') == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                                    <option value="monthly" <?php echo e(old('calculation_interval', 'monthly') == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                </select>
                                <?php $__errorArgs = ['calculation_interval'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3" id="qualifyingItemCol">
                                ...
                                <select class="form-select <?php $__errorArgs = ['qualifying_item'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="all" <?php echo e(old('qualifying_item', 'all') == 'all' ? 'selected' : ''); ?>>All Items</option>
                                    <option value="service" <?php echo e(old('qualifying_item') == 'service' ? 'selected' : ''); ?>>Services Only</option>
                                    <option value="product" <?php echo e(old('qualifying_item') == 'product' ? 'selected' : ''); ?>>Products Only</option>
                                    <option value="membership" <?php echo e(old('qualifying_item') == 'membership' ? 'selected' : ''); ?>>Memberships Only</option>
                                    <option value="package" <?php echo e(old('qualifying_item') == 'package' ? 'selected' : ''); ?>>Packages Only</option>
                                </select>
                                <?php $__errorArgs = ['qualifying_item'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-info text-white">
                        <h6 class="m-0 font-weight-bold">Quick Guide</h6>
                    </div>
                    <div class="card-body">
                        <h6 class="text-primary font-weight-bold">Commission Types:</h6>
                        <ul class="small ps-3">
                            <li><strong>By Target:</strong> Commission based on sales targets over a period.</li>
                            <li><strong>By Item:</strong> Set specific commission rates for services or products.</li>
                        </ul>

                        <h6 class="text-primary mt-3 font-weight-bold">Calculation Methods:</h6>
                        <ul class="small ps-3">
                            <li><strong>Percentage:</strong> % of sale amount.</li>
                            <li><strong>Fixed Value:</strong> Flat commission rate.</li>
                        </ul>

                        <h6 class="text-primary mt-3 font-weight-bold">Item Types:</h6>
                        <ul class="small ps-3">
                            <li>Services</li>
                            <li>Products</li>
                            <li>Memberships</li>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.commissions.index')); ?>" class="btn btn-secondary w-100">
        ...
        <div class="card-body">
            ...
            <div class="row align-items-end">
                <div class="col-md-3 mb-3">
                    <label class="form-label font-weight-bold">From (<?php echo e(currency_symbol()); ?>) <span class="text-danger">*</span></label>
                    <input type="number" class="form-control target-from" name="rules[INDEX][target_from]" step="0.01" min="0" required>
                </div>

                <div class="col-md-3 mb-3">
                    <label class="form-label font-weight-bold">To (<?php echo e(currency_symbol()); ?>)</label>
...
let ruleIndex = 0;
const items = {
    service: <?php echo json_encode($services, 15, 512) ?>,
    product: <?php echo json_encode($products, 15, 512) ?>,
    membership: <?php echo json_encode($memberships, 15, 512) ?>,
    package: <?php echo json_encode($packages, 15, 512) ?>
};
...
$(document).ready(function() {
    ...
    $(document).on('change', '.commission-type-select', function() {
        ...
        if (type === 'percentage') {
            ...
            addon.text('<?php echo e(currency_symbol()); ?>');
        }
    });
});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\commissions\create.blade.php ENDPATH**/ ?>