    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <p class="text-muted mb-0">View and manage payment transaction #<?php echo e($payment->id); ?></p>
            </div>
            <a href="<?php echo e(route('admin.payments.index')); ?>" class="btn btn-light border shadow-sm">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-4 bg-light rounded-3 mb-4 d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-muted small text-uppercase mb-1 fw-bold">
                                    <?php echo e($payment->amount < 0 ? 'Credit Amount' : 'Total Amount'); ?>

                                </p>
                                <h2 class="mb-0 fw-bold <?php echo e($payment->amount < 0 ? 'text-success' : 'text-gray-900'); ?>">
                                    <?php echo e(system_currency_symbol()); ?><?php echo e(number_format(abs($payment->amount), 2)); ?>

                                    <span class="fs-6 text-muted fw-normal"><?php echo e(strtoupper(system_currency())); ?></span>
                        ...
                        <?php if(isset($payment->metadata['proration'])): ?>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="fw-bold text-success">
                                            -<?php echo e(system_currency_symbol()); ?><?php echo e(number_format($payment->metadata['proration']['credit'] ?? 0, 2)); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="fw-bold text-danger">
                                            +<?php echo e(system_currency_symbol()); ?><?php echo e(number_format($payment->metadata['proration']['charge'] ?? 0, 2)); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="small text-muted">
                                            <?php echo e($payment->amount < 0 ? 'Credit applied to account' : 'Amount to pay'); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <?php if($payment->salon): ?>
                                                <a href="<?php echo e(route('admin.salons.show', $payment->salon)); ?>"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-bold text-dark">
                                                <?php echo e(ucfirst($payment->payment_method ?? 'Manual')); ?>

                                            </div>
                                            <div class="small text-muted">
                                                <?php echo e($payment->transaction_id ? 'Ref: ' . Str::limit($payment->transaction_id, 15) : 'No Reference'); ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <?php if($payment->subscription && $payment->subscription->plan): ?>
                                                <div class="fw-bold text-dark"><?php echo e($payment->subscription->plan->name); ?></div>
                                                <div class="small text-muted">
                                                    <?php echo e(ucfirst($payment->subscription->status)); ?>
                        ...
                        <?php if($payment->notes): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-light p-3 rounded border">
                                    <p class="mb-0 text-gray-700"><?php echo e($payment->notes); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                                ...
                                <span class="font-monospace small text-dark bg-light px-2 py-1 rounded">
                                    <?php echo e(Str::limit($payment->transaction_id ?? 'N/A', 20)); ?>

                                </span>
                            </li>
                            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                                <span class="text-muted small">Created</span>
                                <span class="small text-dark"><?php echo e($payment->created_at->diffForHumans()); ?></span>
                            </li>
                            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                                <span class="text-muted small">Last Updated</span>
                                <span class="small text-dark"><?php echo e($payment->updated_at->diffForHumans()); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\super-admin\payments\show.blade.php ENDPATH**/ ?>