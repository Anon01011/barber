        ...
        <!-- Date & Advanced Filters -->
            <div class="card glass-card mb-4">
                <div class="card-body p-4">
                    <form method="GET" action="<?php echo e(route('admin.reports.staff')); ?>" id="filterForm" class="row g-3 align-items-end">
                        <!-- Date Period -->
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <select class="form-select" id="staff_id" name="staff_id">
                                ...
                                <?php $__currentLoopData = $allStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>" <?php echo e($staffIdFilter == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('admin.reports.staff')); ?>" class="btn btn-light border shadow-sm" title="Reset Filters">
                                     ...
                                     <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="service_id" name="service_id">
                                            ...
                                            <?php $__currentLoopData = $allServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($s->id); ?>" <?php echo e($serviceId == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="customer_id" name="customer_id">
                                            ...
                                            <?php $__currentLoopData = $allCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card stat-card-premium bg-primary-grad shadow h-100">
                        <div class="card-body">
                            ...
                            <div class="h3 mb-0 font-weight-bold">
                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalSalonRevenue, 2)); ?>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card stat-card-premium bg-success-grad shadow h-100">
                        <div class="card-body">
                            ...
                            <div class="h3 mb-0 font-weight-bold">
                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalSalonCommission, 2)); ?>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card stat-card-premium bg-info-grad shadow h-100">
                        <div class="card-body">
                            ...
                            <div class="h3 mb-0 font-weight-bold"><?php echo e(currency_symbol()); ?><?php echo e(number_format($totalSalonTips, 2)); ?>
                    ...
                    <div class="card stat-card-premium bg-warning-grad shadow h-100">
                        <div class="card-body">
                            ...
                            <div class="h3 mb-0 font-weight-bold text-truncate">
                                <?php echo e($topPerformer ? $topPerformer['name'] : 'N/A'); ?>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-premium" id="staffTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $staffStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <?php if($staff['avatar']): ?>
                                                    <img src="<?php echo e($staff['avatar']); ?>" class="staff-avatar mr-3">
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <div class="font-weight-bold text-dark"><?php echo e($staff['name']); ?></div>
                                                    <div class="small text-muted">Avg:
                                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['avg_per_booking'], 2)); ?>/visit
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="small">
                                                <span class="badge bg-light text-dark"><?php echo e($staff['booking_count']); ?> Bookings</span>
                                            </div>
                                            <div class="small mt-1">
                                                <span class="badge bg-light text-dark"><?php echo e($staff['pos_count']); ?> POS</span>
                                            </div>
                                        </td>
                                        <td class="text-right">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['service_revenue'], 2)); ?>

                                        </td>
                                        <td class="text-right">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['product_revenue'], 2)); ?>

                                        </td>
                                        <td class="text-right">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['package_revenue'], 2)); ?>

                                        </td>
                                        <td class="text-right font-weight-bold text-primary">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['total_revenue'], 2)); ?>

                                        </td>
                                        <td class="text-right text-success">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['commission'], 2)); ?>

                                        </td>
                                        <td class="text-right text-info">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['tips'], 2)); ?>

                                        </td>
                                        <td class="text-right font-weight-bold text-success">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff['total_earnings'], 2)); ?>

                                        </td>
                                        <td class="text-center">
                                            <?php if($staff['trend'] > 0): ?>
                                                <span class="trend-up"><i class="fas fa-caret-up"></i>
                                                    <?php echo e(number_format($staff['trend'], 1)); ?>%</span>
                                            <?php elseif($staff['trend'] < 0): ?>
                                                <span class="trend-down"><i class="fas fa-caret-down"></i>
                                                    <?php echo e(number_format(abs($staff['trend']), 1)); ?>%</span>
                                            <?php else: ?>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    new Chart(revCtx, {
                        type: 'bar',
                        data: {
                            labels: <?php echo json_encode($staffStats->pluck('name')); ?>,
                            datasets: [{
                                label: 'Service Revenue',
                                data: <?php echo json_encode($staffStats->pluck('service_revenue')); ?>,
                                backgroundColor: '#4e73df',
                                borderRadius: 5,
                            }, {
                                label: 'Product Revenue',
                                data: <?php echo json_encode($staffStats->pluck('product_revenue')); ?>,
                                backgroundColor: '#1cc88a',
                                borderRadius: 5,
                            }, {
                                label: 'Package Revenue',
                                data: <?php echo json_encode($staffStats->pluck('package_revenue')); ?>,
                    ...
                    new Chart(pieCtx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                data: [<?php echo e($totalSalonCommission); ?>, <?php echo e($totalSalonTips); ?>],
                    ...
                    $('#exportStaffBtn').on('click', function () {
                        ...
                        const url = new URL('<?php echo e(route("admin.reports.staff.export")); ?>', window.location.origin);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\reports\staff.blade.php ENDPATH**/ ?>