        ...
        <div class="d-flex align-items-center justify-content-between mb-5">
            ...
            <div class="d-flex gap-2">
                <span class="badge bg-light text-dark border px-3 py-2">
                    <i class="far fa-calendar-alt me-2"></i> <?php echo e(now()->format('F Y')); ?>
                ...
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body position-relative">
                        ...
                        <h2 class="fw-bold text-dark mb-0">
                            <?php echo e(system_currency_symbol()); ?><?php echo e(number_format($totalRevenue, 2)); ?></h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body position-relative">
                        ...
                        <h2 class="fw-bold text-dark mb-0">
                            <?php echo e(system_currency_symbol()); ?><?php echo e(number_format($thisMonthRevenue, 2)); ?></h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body position-relative">
                        ...
                        <h2 class="fw-bold text-dark mb-0"><?php echo e(number_format($activeSubscriptions)); ?></h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body position-relative">
                        ...
                        <h2 class="fw-bold text-dark mb-0"><?php echo e(number_format($totalSalons)); ?></h2>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end">
                        <div class="btn-group shadow-sm">
                            <a href="<?php echo e(route('admin.saas.reports.export.revenue')); ?>"
                                class="btn btn-white border text-dark fw-medium">
                                <i class="fas fa-file-csv me-2 text-success"></i> Revenue.csv
                            </a>
                            <a href="<?php echo e(route('admin.saas.reports.export.subscriptions')); ?>"
                                class="btn btn-white border text-dark fw-medium">
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\super-admin\reports\index.blade.php ENDPATH**/ ?>