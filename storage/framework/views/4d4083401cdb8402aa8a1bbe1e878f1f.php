    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-5">
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2 bg-transparent p-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.super.dashboard')); ?>"
                                class="text-muted text-decoration-none">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.salons.index')); ?>"
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="bg-white rounded-circle shadow-sm border p-1" style="width: 50px; height: 50px;">
                        <img src="<?php echo e($salon->logo_url); ?>" alt="<?php echo e($salon->name); ?>" class="w-100 h-100 rounded-circle object-fit-cover">
                    </div>
                    <div>
            ...
            <div class="d-flex gap-2 mt-3 mt-md-0">
                <?php if((!$salon->is_active || ($salon->activeSubscription && $salon->activeSubscription->status === 'pending'))): ?>
                    <form action="<?php echo e(route('admin.salons.approve', $salon)); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('admin.salons.edit', $salon)); ?>"
                ...
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <h3 class="fw-bold text-dark mb-0">
                            <?php echo e(app(\App\Services\SettingsService::class)->get('currency_symbol', '$', $salon->id)); ?><?php echo e(number_format($stats['total_revenue'], 2)); ?>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <h3 class="fw-bold text-dark mb-0"><?php echo e(number_format($stats['total_bookings'])); ?></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <h3 class="fw-bold text-dark mb-0"><?php echo e(number_format($stats['total_customers'])); ?></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm h-100 overflow-hidden">
                    <div class="card-body p-4">
                        ...
                        <h3 class="fw-bold text-dark mb-0"><?php echo e($stats['total_branches']); ?></h3>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <p class="fw-bold text-dark mb-0"><?php echo e($salon->name); ?></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="text-muted small">Business Type</label>
                                                        <p class="fw-bold text-dark mb-0"><?php echo e(ucfirst($salon->business_type ?? 'salon')); ?></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="text-muted small">Slug / URL</label>
                                                        <p class="mb-0"><code><?php echo e($salon->slug); ?></code></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="text-muted small">Email Address</label>
                                                        <p class="mb-0"><a href="mailto:<?php echo e($salon->email); ?>"
                                                                class="text-decoration-none"><?php echo e($salon->email); ?></a></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="text-muted small">Phone Number</label>
                                                        <p class="fw-bold text-dark mb-0"><?php echo e($salon->phone ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="text-muted small">Website</label>
                                                        <p class="mb-0">
                                                            <?php echo $salon->website ? '<a href="' . $salon->website . '" target="_blank" class="text-decoration-none">' . $salon->website . '</a>' : 'N/A'; ?>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <p class="fw-bold text-dark mb-0">
                                                            <?php echo e($salon->created_at->format('M d, Y')); ?> <span
                                                                class="text-muted fw-normal small">(<?php echo e($salon->created_at->diffForHumans()); ?>)</span>
                                                        </p>
                                                    </div>
                                                    <div class="col-12">
                                                        <label class="text-muted small">Address</label>
                                                        <p class="fw-bold text-dark mb-0"><?php echo e($salon->address ?? 'N/A'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="progress" style="height: 6px;">
                                                                ...
                                                                ?>
                                                                <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo e($percent); ?>%"></div>
                                                            </div>
                                                            <p class="small text-muted mt-2 mb-0">
                                                                <strong><?php echo e($daysLeft); ?> days remaining</strong>. Ends on <?php echo e($salon->trial_ends_at->format('M d, Y')); ?>
                                                ...
                                                <?php elseif($salon->activeSubscription): ?>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                                <h6 class="fw-bold text-dark mb-0"><?php echo e($salon->activeSubscription->plan->name); ?> Plan</h6>
                                                                <?php if($salon->activeSubscription->ends_at && $salon->activeSubscription->ends_at->diffInDays(now()) <= 7): ?>
                                                            ...
                                                            <p class="small text-muted mb-0">
                                                                <?php if($salon->activeSubscription->ends_at): ?>
                                                                    Renews on <strong><?php echo e($salon->activeSubscription->ends_at->format('M d, Y')); ?></strong>
                                                                    (<?php echo e($salon->activeSubscription->ends_at->diffForHumans()); ?>)
                                                                <?php else: ?>
                                                                    Never Expires
                                                                <?php endif; ?>
                                                            </p>
                                    ...
                                    <div class="col-12">
                                        <div class="card border bg-light h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($salon->owner->name ?? 'N/A')); ?>&background=random&size=128"
                                                        class="rounded-circle shadow-sm me-3"
                                                        style="width: 64px; height: 64px;">
                                                    <div>
                                                        <h5 class="fw-bold text-dark mb-1">
                                                            <?php echo e($salon->owner->name ?? 'N/A'); ?>

                                                        </h5>
                                                        <div class="text-muted small mb-1">
                                                            <i class="fas fa-envelope me-1"></i>
                                                            <?php echo e($salon->owner->email ?? 'N/A'); ?>

                                                        </div>
                                                        <?php if($salon->owner && $salon->owner->phone): ?>
                                                            <div class="text-muted small">
                                                                <i class="fas fa-phone me-1"></i> <?php echo e($salon->owner->phone); ?>
                                                    ...
                                                    <div class="ms-auto text-end">
                                                        ...
                                                        <div class="fw-bold text-dark">
                                                            <?php echo e($salon->last_login_at ? $salon->last_login_at->format('M d, Y H:i') : 'Never'); ?>
                                ...
                                <div class="card border h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex justify-content-between align-items-end mb-2">
                                                <div>
                                                    ...
                                                    <small class="text-muted"><?php echo e($stats['monthly_revenue'] > 0 && $stats['total_revenue'] > 0 ? round(($stats['monthly_revenue'] / $stats['total_revenue']) * 100, 1) . '% of total' : 'New'); ?></small>
                                                </div>
                                                <span class="fw-bold text-success h5 mb-0">
                                                    <?php echo e(app(\App\Services\SettingsService::class)->get('currency_symbol', '$', $salon->id)); ?>

                                                    <?php echo e(number_format($stats['monthly_revenue'], 2)); ?>
                                            ...
                                            <div class="progress bg-success-subtle" style="height: 8px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: <?php echo e($revPercent); ?>%; border-radius: 6px;" aria-valuenow="<?php echo e($revPercent); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex justify-content-between align-items-end mb-2">
                                                <div>
                                                    ...
                                                    ?>
                                                    <small class="text-muted"><?php echo e($isUnlimited ? 'Contribution: ' . round($bookingPercent, 1) . '%' : 'Usage: ' . round($bookingPercent, 1) . '%'); ?></small>
                                                </div>
                                                <span class="fw-bold text-primary h5 mb-0"><?php echo e(number_format($stats['monthly_bookings'])); ?> <small class="text-muted fs-6 fw-normal">/ <?php echo e($isUnlimited ? '∞' : $bookingLimit); ?></small></span>
                                            </div>
                                            <div class="progress bg-primary-subtle" style="height: 8px;">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    style="width: <?php echo e($barPercent); ?>%; border-radius: 6px;" aria-valuenow="<?php echo e($barPercent); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex justify-content-between align-items-end mb-2">
                                                <div>
                                                    ...
                                                    ?>
                                                    <small class="text-muted"><?php echo e($isPkgUnlimited ? 'Unlimited' : 'Limit: ' . $pkgLimit); ?></small>
                                                </div>
                                                <span class="fw-bold text-dark h6 mb-0"><?php echo e($stats['total_packages'] ?? 0); ?> <small class="text-muted fw-normal">/ <?php echo e($isPkgUnlimited ? '∞' : $pkgLimit); ?></small></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex justify-content-between align-items-end mb-2">
                                                <div>
                                                    ...
                                                    ?>
                                                    <small class="text-muted"><?php echo e($isMemUnlimited ? 'Unlimited' : 'Limit: ' . $memLimit); ?></small>
                                                </div>
                                                <span class="fw-bold text-dark h6 mb-0"><?php echo e($stats['total_memberships'] ?? 0); ?> <small class="text-muted fw-normal">/ <?php echo e($isMemUnlimited ? '∞' : $memLimit); ?></small></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="<?php echo e(route('booking.guest', ['salon_slug' => $salon->slug])); ?>"
                                            ...
                                            <a href="<?php echo e(route('admin.notifications.create', ['salon_id' => $salon->id])); ?>"
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <?php if($salon->activeSubscription): ?>
                                            ...
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <span
                                                    class="fw-bold text-dark"><?php echo e(app(\App\Services\SettingsService::class)->get('currency_symbol', '$', $salon->id)); ?>

                                                    <?php echo e(number_format($salon->activeSubscription->plan->price, 2)); ?> /
                                                    month</span>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span
                                                    class="fw-medium text-dark"><?php echo e($salon->activeSubscription->ends_at ? $salon->activeSubscription->ends_at->format('M d, Y') : 'N/A'); ?></span>
                                            </div>
                                        <?php else: ?>
                                            ...
                                            <div class="alert alert-info border-0 bg-info-subtle text-info-emphasis mb-0">
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 small"><?php echo e($salon->trialDaysLeft()); ?> days remaining.
                                                            Trial ends on <span
                                                                class="fw-bold"><?php echo e($salon->trial_ends_at->format('M d, Y')); ?></span>.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $salon->subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td class="px-4 fw-medium"><?php echo e($sub->plan->name); ?></td>
                                                            <td class="px-4">
                                                                <?php echo e(app(\App\Services\SettingsService::class)->get('currency_symbol', '$', $salon->id)); ?>

                                                                <?php echo e(number_format($sub->plan->price, 2)); ?>

                                                            </td>
                                                            <td class="px-4">
                                                                <span
                                                                    class="badge bg-<?php echo e($sub->status === 'active' ? 'success' : ($sub->status === 'expired' ? 'danger' : 'secondary')); ?>-subtle text-<?php echo e($sub->status === 'active' ? 'success' : ($sub->status === 'expired' ? 'danger' : 'secondary')); ?> border border-<?php echo e($sub->status === 'active' ? 'success' : ($sub->status === 'expired' ? 'danger' : 'secondary')); ?>-subtle px-2 py-1 rounded-pill">
                                                                    <?php echo e(ucfirst($sub->status)); ?>

                                                                </span>
                                                            </td>
                                                            <td class="px-4 text-muted small">
                                                                <?php echo e($sub->starts_at->format('M d, Y')); ?>

                                                            </td>
                                                            <td class="px-4 text-muted small">
                                                                <?php echo e($sub->ends_at ? $sub->ends_at->format('M d, Y') : 'N/A'); ?>
                    ...
                    <div class="tab-pane fade" id="users" role="tabpanel">
                        <div class="card border shadow-sm">
                            <div
                                ...
                                <span
                                    class="badge bg-primary-subtle text-primary rounded-pill px-3"><?php echo e($salon->users->count()); ?>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $salon->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="px-4">
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td class="px-4 text-muted"><?php echo e($user->email); ?></td>
                                                    <td class="px-4">
                                                        <?php $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <span
                                                                class="badge bg-light text-dark border me-1 fw-normal"><?php echo e($role->name); ?></span>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </td>
                                                    <td class="px-4">
                                                        <span
                                                            class="badge bg-<?php echo e($user->status === 'active' ? 'success' : 'danger'); ?>-subtle text-<?php echo e($user->status === 'active' ? 'success' : 'danger'); ?> border border-<?php echo e($user->status === 'active' ? 'success' : 'danger'); ?>-subtle rounded-pill px-2">
                                                            <?php echo e(ucfirst($user->status)); ?>

                                                        </span>
                                                    </td>
                                                    <td class="px-4 text-muted small"><?php echo e($user->created_at->format('M d, Y')); ?>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="badge bg-dark rounded-pill px-3"><?php echo e($branches->count()); ?> Total</span>
                                </div>
                            </div>
                                    ...
                                    <div class="card border shadow-sm h-100 position-relative overflow-hidden">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div>
                                                    <h6 class="fw-bold text-dark mb-1"><?php echo e($branch->name); ?></h6>
                                                    <div class="text-muted small"><i class="fas fa-map-marker-alt me-1"></i>
                                                        <?php echo e(\Illuminate\Support\Str::limit($branch->address ?? 'No address', 30)); ?>
                                            ...
                                            <div class="vstack gap-2 mb-4">
                                                <div class="d-flex align-items-center text-muted small">
                                                    <i class="fas fa-phone fa-fw me-2"></i> <?php echo e($branch->phone ?? 'No phone'); ?>

                                                </div>
                                                <div class="d-flex align-items-center text-muted small">
                                                    <i class="fas fa-envelope fa-fw me-2"></i>
                                                    <?php echo e($branch->email ?? 'No email'); ?>
                                            ...
                                            <div class="row g-2 pt-3 border-top">
                                                <div class="col-6">
                                                    <div class="text-center p-2 rounded bg-light">
                                                        <div class="fw-bold text-dark h5 mb-0"><?php echo e($branch->users_count); ?></div>
                                                ...
                                                <div class="col-6">
                                                    <div class="text-center p-2 rounded bg-light">
                                                        <div class="fw-bold text-dark h5 mb-0"><?php echo e($branch->bookings_count); ?>
                    ...
                    <div class="tab-pane fade" id="payments" role="tabpanel">
                        <div class="card border shadow-sm">
                                    <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="<?php echo e(route('admin.payments.index', ['salon_id' => $salon->id])); ?>" class="btn btn-sm btn-primary shadow-sm px-3">View All History</a>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <tr>
                                                            <td class="px-4 text-muted small">#<?php echo e($payment->id); ?></td>
                                                            <td class="px-4 text-muted small"><?php echo e($payment->created_at->format('M d, Y H:i')); ?></td>
                                                            <td class="px-4 fw-bold text-dark">
                                                                <?php echo e(app(\App\Services\SettingsService::class)->get('currency_symbol', '$', $salon->id)); ?><?php echo e(number_format(abs($payment->amount), 2)); ?>

                                                            </td>
                                                            <td class="px-4 text-muted small"><?php echo e(ucfirst($payment->payment_method ?? 'N/A')); ?></td>
                                                            <td class="px-4">
                                                                <span class="badge bg-<?php echo e($payment->status === 'completed' ? 'success' : ($payment->status === 'pending' ? 'warning' : 'danger')); ?>-subtle text-<?php echo e($payment->status === 'completed' ? 'success' : ($payment->status === 'pending' ? 'warning' : 'danger')); ?> border border-<?php echo e($payment->status === 'completed' ? 'success' : ($payment->status === 'pending' ? 'warning' : 'danger')); ?>-subtle rounded-pill px-2">
                            ...
                            <div class="tab-pane fade" id="settings" role="tabpanel">
                                <div class="row g-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-sm table-borderless mb-0">
                                                        <tr>
                                                            ...
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_driver ?? 'Default'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-muted small py-2">Host</th>
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_host ?? 'N/A'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-muted small py-2">Port</th>
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_port ?? 'N/A'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-muted small py-2">Encryption</th>
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_encryption ?? 'N/A'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-muted small py-2">From Address</th>
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_from_address ?? 'N/A'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-muted small py-2">From Name</th>
                                                            <td class="small fw-bold text-dark py-2"><?php echo e($salon->mail_from_name ?? 'N/A'); ?></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="d-grid">
                                            <a href="<?php echo e(route('admin.salons.edit', $salon)); ?>" class="btn btn-primary shadow-sm">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\super-admin\salons\show.blade.php ENDPATH**/ ?>