<?php $__env->startSection('title', 'Add Discount Membership'); ?>
<?php $__env->startSection('content'); ?>
    <div class="container-fluid membership-container py-4">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-3">
                    <h1 class="h4 fw-bold text-primary">
                        <i class="fas fa-id-card me-2"></i> Add Discount Membership
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb small mb-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.memberships.index')); ?>">Memberships</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Create</li>
                        </ol>
                    </nav>
                </div>
                <span class="text-muted small">Create real-time discounts; discount value is automatically calculated during
                    billing.</span>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg">
                <form action="<?php echo e(route('admin.memberships.store')); ?>" method="POST" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row g-3 mb-2">
                                <div class="col-md-4">
                                    <label for="name" class="form-label fw-semibold">Membership Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control form-control-lg <?php if($errors->has('name')): ?> is-invalid <?php endif; ?>"
                                        id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="E.g. Salon VIP"
                                        required>
...
unset($__errorArgs, $__bag); ?>
                                    <div id="name-error" class="invalid-feedback d-none">Please enter a membership name.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="discount_value" class="form-label fw-semibold">Discount Value <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><?php echo e($globalSettings['currency_symbol']); ?></span>
                                        <input type="number" step="1"
                                            class="form-control <?php if($errors->has('discount_value')): ?> is-invalid <?php endif; ?>"
                                            id="discount_value" name="discount_value"
                                            value="<?php echo e(is_array(old('discount_value')) ? '' : old('discount_value', '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    <label for="is_taxable" class="form-label fw-semibold">Tax <span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" id="is_taxable"
                                        name="is_taxable" required>
                                        <option value="0" <?php echo e(old('is_taxable', 0) == 0 ? 'selected' : ''); ?>>Not Applicable
                                        </option>
                                        <option value="1" <?php echo e(old('is_taxable') == 1 ? 'selected' : ''); ?>>Taxable</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <label for="validity_value" class="form-label fw-semibold">Validity Duration <span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                        id="validity_value" name="validity_value" value="<?php echo e(old('validity_value', 30)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    <div id="validity-value-error" class="invalid-feedback d-none">Please enter validity
                                        duration.</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="validity_unit" class="form-label fw-semibold">Validity Unit <span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                        id="validity_unit" name="validity_unit" required>
                                        <option value="days" <?php echo e(old('validity_unit', 'days') == 'days' ? 'selected' : ''); ?>>
                                            Days</option>
                                        <option value="weeks" <?php echo e(old('validity_unit') == 'weeks' ? 'selected' : ''); ?>>Weeks
                                        </option>
                                        <option value="months" <?php echo e(old('validity_unit') == 'months' ? 'selected' : ''); ?>>Months
                                        </option>
                                        <option value="years" <?php echo e(old('validity_unit') == 'years' ? 'selected' : ''); ?>>Years
                                        </option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                    <div id="validity-unit-error" class="invalid-feedback d-none">Please select validity
                                        unit.</div>
                                </div>
                                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>"
                                            type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="description"
                                    ...
                                    placeholder="Describe the membership"><?php echo e(old('description')); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-all" value="all" <?php echo e(old('membership_type', 'all') == 'all' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-services" value="services" <?php echo e(old('membership_type') == 'services' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="membership_type"
                                                id="membership-type-products" value="products" <?php echo e(old('membership_type') == 'products' ? 'checked' : ''); ?>>
                    ...
                    <div class="card mb-4 shadow-sm" id="items-card">
                        <div class="card-header bg-white">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0 fw-semibold"><i class="fas fa-list-ul me-2"></i> Membership Items (Services
                                    & Products) <span class="text-danger">*</span></h5>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="dropdown">
                                        <button class="btn btn-outline-secondary btn-sm dropdown-toggle" type="button"
                                            id="service-dropdown-btn" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                            aria-expanded="false" style="width: 250px;">
                                            Select services...
                                        </button>
                                        <div class="dropdown-menu p-3" id="service-dropdown-menu"
                                            ...
                                            <div id="service-list">
                                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check service-item"
                                                        data-name="<?php echo e(strtolower($service->name)); ?>" data-type="service">
                                                        <input class="form-check-input service-checkbox" type="checkbox"
                                                            id="service-<?php echo e($service->id); ?>" value="<?php echo e($service->id); ?>"
                                                            data-price="<?php echo e($service->price); ?>" data-name="<?php echo e($service->name); ?>"
                                                            data-type="service">
                                                        <label class="form-check-label" for="service-<?php echo e($service->id); ?>">
                                                            <?php echo e($service->name); ?> - <?php echo e($globalSettings['currency_symbol']); ?>
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-outline-secondary btn-sm dropdown-toggle" type="button"
                                            id="product-dropdown-btn" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                            aria-expanded="false" style="width: 250px;">
                                            Select products...
                                        </button>
                                        <div class="dropdown-menu p-3" id="product-dropdown-menu"
                                            style="width: 300px; max-height: 300px; overflow-y: auto;">
                                            <div class="mb-2">
                                            ...
                                            <div id="product-list">
                                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check product-item"
                                                        data-name="<?php echo e(strtolower($product->name)); ?>" data-type="product">
                                                        <input class="form-check-input product-checkbox" type="checkbox"
                                                            id="product-<?php echo e($product->id); ?>" value="<?php echo e($product->id); ?>"
                                                            data-price="<?php echo e($product->selling_price); ?>"
                                                            data-name="<?php echo e($product->name); ?>" data-type="product">
                                                        <label class="form-check-label" for="product-<?php echo e($product->id); ?>">
                                                            <?php echo e($product->name); ?> - <?php echo e($globalSettings['currency_symbol']); ?>
                        ...
                        <div class="card-body pt-3">
                            <div id="items-error" class="invalid-feedback d-none mb-2">Add at least one item (service or
                                product).</div>
                            ...
                            <div class="pt-3">
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-select form-select-sm" id="bulk-discount-type"
                                            style="width: 90px;">
                                    ...
                                    <div class="col-auto">
                                        <input type="number" class="form-control form-control-sm" id="bulk-discount-value"
                                            placeholder="0" min="0" step="0.01" style="width:100px;">
                                    </div>
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-outline-primary btn-sm" id="apply-all-btn"><i
                                                class="fas fa-magic"></i> Apply All</button>
                                    </div>
                                    <div class="col">
                                        <span class="form-text small" id="bulk-apply-summary" style="display: none;">Applied
                                            to <span id="applied-count">0</span> item(s).</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table style="display:none;">
                        <tbody id="item-row-template">
                            <tr class="item-row" data-row-index="">
                                ...
                                <td><input type="number" class="form-control form-control-sm quantity-input" value="1"
                                        min="1" name="quantity[]"></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <input type="number" class="form-control form-control-sm discount-input" value="0"
                                        min="0" step="0.01">
                    ...
                    <div class="card mt-4 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('admin.memberships.index')); ?>" class="btn btn-outline-secondary"><i
                                        class="fas fa-arrow-left me-2"></i> Cancel</a>
                                <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save me-2"></i>
                                    Save</button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\memberships\create.blade.php ENDPATH**/ ?>