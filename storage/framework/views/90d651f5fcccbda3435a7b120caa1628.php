    ...
    <div class="container-fluid">
        ...
        <div class="card glass-card mb-4">
            <div class="card-body p-4">
                <form method="GET" action="<?php echo e(route('admin.reports.sales')); ?>" id="filterForm"
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            <div style="min-width: 160px; max-width: 200px;">
                                <select class="form-select" id="range" name="range">
                                    ...
                                    <option value="yesterday" <?php echo e($range == 'yesterday' ? 'selected' : ''); ?>>Yesterday</option>
                                    <option value="this_week" <?php echo e($range == 'this_week' ? 'selected' : ''); ?>>This Week</option>
                                    <option value="last_week" <?php echo e($range == 'last_week' ? 'selected' : ''); ?>>Last Week</option>
                                    <option value="this_month" <?php echo e($range == 'this_month' ? 'selected' : ''); ?>>This Month
                                    </option>
                                    <option value="last_month" <?php echo e($range == 'last_month' ? 'selected' : ''); ?>>Last Month
                                    </option>
                                    <option value="3_months" <?php echo e($range == '3_months' ? 'selected' : ''); ?>>Last 3 Months
                                    </option>
                                    <option value="6_months" <?php echo e($range == '6_months' ? 'selected' : ''); ?>>Last 6 Months
                                    </option>
                                    <option value="this_year" <?php echo e($range == 'this_year' ? 'selected' : ''); ?>>This Year</option>
                                    <option value="custom" <?php echo e($range == 'custom' ? 'selected' : ''); ?>>Custom Range</option>
                                </select>
                            </div>

                            <!-- Custom Dates side-by-side -->
                            <div class="date-inputs" style="<?php echo e($range !== 'custom' ? 'display: none;' : ''); ?>">
                                <div class="d-flex align-items-center gap-2">
                                    <input type="date" class="form-control" id="start_date" name="start_date"
                                        value="<?php echo e($startDate); ?>" title="From Date" style="max-width: 140px;">
                                    <span class="text-muted small px-1">to</span>
                                    <input type="date" class="form-control" id="end_date" name="end_date"
                                        value="<?php echo e($endDate); ?>" title="To Date" style="max-width: 140px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-6" style="max-width: 200px;">
                        ...
                        <select class="form-select" id="staff_id" name="staff_id">
                            ...
                            <?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($s->id); ?>" <?php echo e($staffId == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?></option>
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-6" style="max-width: 200px;">
                        ...
                        <select class="form-select" id="source" name="source">
                            ...
                            <option value="bookings" <?php echo e($source == 'bookings' ? 'selected' : ''); ?>>Bookings Only</option>
                            <option value="pos" <?php echo e($source == 'pos' ? 'selected' : ''); ?>>POS Sales Only</option>
                        </select>
                    </div>
                    ...
                    <div class="col-xl-auto col-md-12 col-sm-12 ms-xl-auto mt-xl-0 mt-3 align-self-end">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('admin.reports.sales')); ?>" class="btn btn-light border shadow-sm"
                                title="Reset Filters">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select select2" id="customer_id" name="customer_id">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($c->id); ?>" <?php echo e($customerId == $c->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="payment_status" name="payment_status">
                                        ...
                                        <option value="unpaid" <?php echo e(request('payment_status') == 'unpaid' ? 'selected' : ''); ?>>
                                            Unpaid</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="payment_method" name="payment_method">
                                        ...
                                        <option value="card" <?php echo e(request('payment_method') == 'card' ? 'selected' : ''); ?>>Card
                                        </option>
                                        <option value="online" <?php echo e(request('payment_method') == 'online' ? 'selected' : ''); ?>>
                                            Online</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select select2" id="cashier_id" name="cashier_id">
                                        <option value="">All Staff</option>
                                        <?php $__currentLoopData = $staffMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($s->id); ?>" <?php echo e($cashierId == $s->id ? 'selected' : ''); ?>>
                                                <?php echo e($s->name); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalRevenue, 2)); ?>

                                </div>
                                <?php if($source == 'all'): ?>
                                    <div class="x-small text-muted mt-1 d-flex flex-wrap gap-2">
                                        <span><i class="fas fa-circle text-info" style="font-size: 6px;"></i> B:
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($bookingRevenue, 2)); ?></span>
                                        <span><i class="fas fa-circle text-warning" style="font-size: 6px;"></i> P:
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($posRevenue, 2)); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalUnpaid, 2)); ?>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalRefunded ?? 0, 2)); ?>

                                </div>
                                <div class="x-small text-muted mt-1 d-flex flex-wrap gap-2">
                                    <span title="Net Returned to Customer">
                                        <i class="fas fa-hand-holding-usd me-1"></i>Net:
                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format(($totalRefunded ?? 0) - ($posRefundFees ?? 0), 2)); ?>

                                    </span>
                                    <?php if(($posRefundFees ?? 0) > 0): ?>
                                        <span class="text-danger" title="Total Fees Retained">
                                            <i class="fas fa-cut me-1"></i>Fees:
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($posRefundFees, 2)); ?>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalTips, 2)); ?>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($netRevenue, 2)); ?>

                                </div>
                                <div class="x-small text-muted mt-1">
                                    <span class="text-danger"><i class="fas fa-minus-circle me-1"></i>Tax:
                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalTax, 2)); ?></span>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalCommission, 2)); ?>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800"><?php echo e($totalTransactions); ?></div>
                                <div class="x-small text-muted mt-1">
                                    Avg: <?php echo e(currency_symbol()); ?><?php echo e(number_format($averageTransaction, 2)); ?>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover align-middle" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $paginatedTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="fw-bold"><?php echo e(format_date($transaction['date'])); ?></div>
                                        <div class="small text-muted"><?php echo e(format_time($transaction['date'])); ?></div>
                                    </td>
                                    <td>
                                        <?php if($transaction['type'] === 'booking'): ?>
                                            <?php if(!empty($transaction['booking_group_id'])): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php elseif($transaction['type'] === 'pos' && ($transaction['subtype'] ?? '') === 'booking'): ?>
                                    ...
                                    <td>
                                        <div class="fw-bold">
                                            <?php echo e($transaction['customer'] ? $transaction['customer']->name : ($transaction['type'] === 'booking' ? 'Guest' : 'Walk-in')); ?>

                                        </div>
                                        <?php if($transaction['customer'] && isset($transaction['customer']->is_guest) && $transaction['customer']->is_guest): ?>
                                    ...
                                    <td>
                                        <?php if($transaction['type'] === 'booking'): ?>
                                            ...
                                            <?php else: ?>
                                                <?php echo e($transaction['data']->service ? $transaction['data']->service->name : 'N/A'); ?>

                                            <?php endif; ?>
                                        <?php else: ?>
                                            <small class="text-muted">
                                                <?php echo e($transaction['data']->items->count()); ?> item(s)
                                            </small>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($transaction['staff']): ?>
                                            <div class="d-flex align-items-center">
                                                <div class="rounded-circle <?php echo e($transaction['type'] === 'booking' ? 'bg-primary' : 'bg-success'); ?> text-white d-flex align-items-center justify-content-center me-2"
                                                    style="width: 24px; height: 24px; font-size: 10px;">
                                                    <?php echo e(substr($transaction['staff']->name, 0, 1)); ?>
                                    ...
                                    <td><span
                                            class="badge bg-light text-dark border"><?php echo e($transaction['payment_method'] ?: 'N/A'); ?></span>
                                    </td>
                                    <td class="text-end fw-bold">
                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($transaction['amount'], 2)); ?>

                                    </td>
                                    <td class="text-end text-success">
                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($transaction['tip'], 2)); ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>
                                        <span
                                            class="badge <?php echo e($badgeClass); ?> bg-opacity-10 text-<?php echo e(str_replace('bg-', '', $badgeClass)); ?> badge-premium">
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-primary view-transaction-btn"
                                            data-type="<?php echo e($transaction['type']); ?>" data-id="<?php echo e($transaction['id']); ?>">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div class="text-muted small">
                        Showing <?php echo e($paginatedTransactions->firstItem() ?? 0); ?> to
                        <?php echo e($paginatedTransactions->lastItem() ?? 0); ?> of <?php echo e($paginatedTransactions->total()); ?> transactions
                    </div>
                    <div>
                        <?php echo e($paginatedTransactions->links()); ?>
                            ...
                            <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="me-3 d-inline-block">
                                    <i class="fas fa-circle"
                                        style="color: <?php echo e($loop->iteration == 1 ? '#4e73df' : ($loop->iteration == 2 ? '#1cc88a' : '#36b9cc')); ?>"></i>
                                    <?php echo e($method['method']); ?>

                                    <span
                                        class="fw-bold text-gray-800 ms-1"><?php echo e(currency_symbol()); ?><?php echo e(number_format($method['total'], 2)); ?></span>
                                </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                            <?php $__currentLoopData = $categoryRevenue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="me-2">
                                    <i class="fas fa-circle"
                                        style="color: <?php echo e($loop->iteration == 1 ? '#4e73df' : ($loop->iteration == 2 ? '#1cc88a' : ($loop->iteration == 3 ? '#36b9cc' : '#f6c23e'))); ?>"></i>
                                    <?php echo e($category); ?>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="p-3 border rounded bg-light text-center">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($customerMetrics['new']); ?></div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="p-3 border rounded bg-light text-center">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Returning
                                        Customers</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($customerMetrics['returning']); ?>
                            ...
                            <div class="col-12">
                                <div class="p-3 border rounded bg-light text-center">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Unique
                                        Customers</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($customerMetrics['total']); ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.view-transaction-btn').on('click', function () {
                    ...
                    $.ajax({
                        url: `/<?php echo e(auth()->user()->salon->slug); ?>/admin/reports/transaction/${type}/${id}`,
                        method: 'GET',
                ...
                const categoryRevenueData = <?php echo json_encode($categoryRevenue, 15, 512) ?>;
                ...
                const hourlyTrafficData = <?php echo json_encode($hourlyTraffic, 15, 512) ?>;
                ...
                document.getElementById('exportSalesBtn').addEventListener('click', function () {
                    ...
                    const url = new URL('<?php echo e(route("admin.reports.sales.export")); ?>', window.location.origin);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\reports\sales.blade.php ENDPATH**/ ?>