...
<head>
    ...
    <title>Subscription Paused - <?php echo e(config('app.name')); ?></title>
        ...
        <div class="auth-right">
            <div class="auth-card">
                <div style="text-align: center; margin-bottom: 1.5rem;">
                    <div
                        style="width: 80px; height: 80px; background-color: #dbeafe; color: #1e40af; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem auto; font-size: 2rem;">
                        <i class="fas fa-pause-circle"></i>
                    </div>
                    <h2 class="auth-header">Subscription Paused</h2>
                    <p style="text-align: center; color: #64748b; margin-bottom: 1.25rem; font-size: 0.875rem;">Your
                        salon subscription has been paused by the administrator.</p>
                </div>

                <div
                    style="background: #eff6ff; color: #1e40af; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem; font-size: 0.875rem; text-align: center;">
                    <i class="fas fa-info-circle me-2"></i>
                    <?php echo e(session('error') ?? 'Access to your dashboard is temporarily restricted. Please contact support for more information.'); ?>
...
</html><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\errors\subscription-paused.blade.php ENDPATH**/ ?>