        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="form-check form-switch custom-switch pt-4">
                    <input class="form-check-input" type="checkbox" name="guest_booking_enabled" value="1"
                        id="guest_booking_enabled" <?php echo e(($settings['guest_booking_enabled'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="default_guest_status">
                    <option value="pending" <?php echo e(($settings['default_guest_status'] ?? 'pending') == 'pending' ? 'selected' : ''); ?>>Pending Approval</option>
                    <option value="confirmed" <?php echo e(($settings['default_guest_status'] ?? 'pending') == 'confirmed' ? 'selected' : ''); ?>>Auto-Confirmed</option>
                </select>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <input type="number" name="slot_duration" class="form-control"
                        value="<?php echo e($settings['slot_duration'] ?? 30); ?>" min="5" max="120" step="5">
    ...
    <div class="settings-field-group">
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <input type="number" name="appointment_buffer_time" class="form-control"
                        value="<?php echo e($settings['appointment_buffer_time'] ?? 15); ?>" min="0" step="5">
                    <span class="input-group-text bg-light">Minutes</span>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-white"><?php echo e($settings['currency_symbol'] ?? '$'); ?></span>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch mt-4">
                    <input class="form-check-input" type="checkbox" name="auto_confirm_bookings" value="1"
                        id="auto_confirm_bookings" <?php echo e(($settings['auto_confirm_bookings'] ?? false) ? 'checked' : ''); ?>>
                    <label class="form-check-label fw-semibold small text-uppercase text-secondary"
            ...
            <div class="col-12">
                ...
                <textarea name="cancellation_policy" class="form-control" rows="4"
                    placeholder="Describe your cancellation policy here..."><?php echo e($settings['cancellation_policy'] ?? ''); ?></textarea>
                <small class="text-muted">This will be shown to customers during the booking process.</small>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\settings\partials\appointments.blade.php ENDPATH**/ ?>