...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid px-3 py-2 d-flex flex-column" style="height: calc(100vh - 70px); overflow: hidden;">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2 mt-3 mt-md-0 align-items-center">
                <a href="<?php echo e(route('admin.bookings.settings')); ?>" class="btn btn-outline-secondary"
                            ...
                            <li>
                                <div class="form-check">
                                    <input class="form-check-input staff-filter-checkbox" type="checkbox"
                                        value="<?php echo e($staff->id); ?>" id="staffFilter<?php echo e($staff->id); ?>" checked>
                                    <label class="form-check-label w-100" for="staffFilter<?php echo e($staff->id); ?>">
                ...
                <div class="ms-2 d-none" id="datePickerContainer">
                    <input type="date" id="calendarDatePicker" class="form-control"
                        value="<?php echo e(\Carbon\Carbon::now(salon_timezone())->format('Y-m-d')); ?>">
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make('components.past-time-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="mt-1">
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <span
                                                                    id="unpaidAmountTextDetails"><?php echo e(currency_symbol()); ?>0.00</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-6">
                                                        <div class="stat-card">
                                                            ...
                                                            <strong id="customerUnpaidBalance"><?php echo e(currency_symbol()); ?>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="stat-card">
                                                            ...
                                                            <strong id="customerTotalRevenue"><?php echo e(currency_symbol()); ?>
...
<?php $__env->startPush('styles'); ?>
    ...
    <style>
        ...
        .detail-section .badge.bg-success {
            background:
                <?php echo e($settings['confirmed_color'] ?? '#f0fdf4'); ?>

                !important;
            border: 1px solid
                <?php echo e($settings['confirmed_border'] ?? '#86efac'); ?>

                !important;
            color:
                <?php echo e($settings['confirmed_text'] ?? '#166534'); ?>
        ...
        .detail-section .badge.bg-warning {
            background:
                <?php echo e($settings['pending_color'] ?? '#f8fafc'); ?>

                !important;
            border: 1px solid
                <?php echo e($settings['pending_border'] ?? '#e2e8f0'); ?>

                !important;
            color:
                <?php echo e($settings['pending_text'] ?? '#000000'); ?>
        ...
        .detail-section .badge.bg-info {
            background:
                <?php echo e($settings['completed_color'] ?? '#eff6ff'); ?>

                !important;
            border: 1px solid
                <?php echo e($settings['completed_border'] ?? '#93c5fd'); ?>

                !important;
            color:
                <?php echo e($settings['completed_text'] ?? '#1e40af'); ?>
        ...
        .detail-section .badge.bg-danger {
            background:
                <?php echo e($settings['cancelled_color'] ?? '#fef2f2'); ?>

                !important;
            border: 1px solid
                <?php echo e($settings['cancelled_border'] ?? '#fca5a5'); ?>

                !important;
            color:
                <?php echo e($settings['cancelled_text'] ?? '#991b1b'); ?>
        ...
        .fc-event-unpaid {
            background:
                <?php echo e($settings['booking_color_unpaid'] ?? '#dc3545'); ?>

                !important;
            color:
                <?php echo e($settings['booking_text_unpaid'] ?? '#ffffff'); ?>

                !important;
            border: 1px solid
                <?php echo e($settings['booking_border_unpaid'] ?? '#dc3545'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.servicesData = <?php echo json_encode($services ?? [], 15, 512) ?>;
        window.calendarSettings = <?php echo json_encode($settings ?? [], 15, 512) ?>;
        window.packagesData = <?php echo json_encode($packages ?? [], 15, 512) ?>;
        window.staffMembers = <?php echo json_encode($staffMembers ?? [], 15, 512) ?>;
        window.userRoles = <?php echo json_encode(auth()->user()->getRoleNames(), 15, 512) ?>;
        window.currencySymbol = '<?php echo e(currency_symbol()); ?>';
    </script>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/calendar-init.js']); ?>
    <script>
                            ...
                            .then(data => {
                                if (data.success && data.bills) {
                                    ...
                                    if (unpaidAmount > 0) {
                                        ...
                                        unpaidAmountTextDetails.textContent = '<?php echo e(currency_symbol()); ?>' + unpaidAmount.toFixed(2);
                    ...
                    if (data.staff.services.length === 0) {
                        ...
                        data.staff.services.forEach(service => {
                            ...
                            row.innerHTML = `
                                ...
                                <td class="text-end py-2 fw-semibold text-dark small"><?php echo e(currency_symbol()); ?>${parseFloat(service.price).toFixed(2)}</td>
                            `;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views/bookings/index.blade.php ENDPATH**/ ?>