    ...
    <div class="container-fluid px-4">
        ...
        <div class="card glass-card border-0 mb-4">
            <div class="card-body p-4">
                <form method="GET" action="<?php echo e(route('admin.reports.customers')); ?>" id="filterForm">
                    <div class="row g-3 align-items-end mb-3">
                        ...
                        <div class="col-xl-3 col-md-4">
                            ...
                            <select class="form-select" id="range" name="range">
                                ...
                                <option value="this_month" <?php echo e($range == 'this_month' ? 'selected' : ''); ?>>This Month</option>
                                <option value="last_month" <?php echo e($range == 'last_month' ? 'selected' : ''); ?>>Last Month</option>
                                <option value="3_months" <?php echo e($range == '3_months' ? 'selected' : ''); ?>>Last 3 Months</option>
                                <option value="6_months" <?php echo e($range == '6_months' ? 'selected' : ''); ?>>Last 6 Months</option>
                            ...
                            <div class="input-group mt-2 date-inputs"
                                style="<?php echo e($range !== 'custom' ? 'display: none;' : ''); ?>">
                        ...
                        <div class="col-xl-2 col-md-3">
                            ...
                            <select class="form-select" id="branch_id" name="branch_id">
                                ...
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($b->id); ?>" <?php echo e($branchId == $b->id ? 'selected' : ''); ?>><?php echo e($b->name); ?>
                        ...
                        <div class="col-xl-2 col-md-3">
                            ...
                            <select class="form-select" id="segment" name="segment">
                                ...
                                <option value="VIP" <?php echo e($segmentFilter == 'VIP' ? 'selected' : ''); ?>>VIP</option>
                                <option value="Loyal" <?php echo e($segmentFilter == 'Loyal' ? 'selected' : ''); ?>>Loyal</option>
                                <option value="Regular" <?php echo e($segmentFilter == 'Regular' ? 'selected' : ''); ?>>Regular</option>
                                <option value="New" <?php echo e($segmentFilter == 'New' ? 'selected' : ''); ?>>New</option>
                            </select>
                        </div>
                        ...
                        <div class="col-xl-5 col-md-12">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="<?php echo e(route('admin.reports.customers')); ?>" class="btn btn-icon-only"
                                    title="Reset Filters">
                            ...
                            <div class="row g-4">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="staff_id" name="staff_id">
                                        ...
                                        <?php $__currentLoopData = $allStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($s->id); ?>" <?php echo e($staffId == $s->id ? 'selected' : ''); ?>><?php echo e($s->name); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="service_id" name="service_id">
                                        ...
                                        <?php $__currentLoopData = $allServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($s->id); ?>" <?php echo e($serviceId == $s->id ? 'selected' : ''); ?>>
                                                <?php echo e($s->name); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        ...
                                        <option value="completed" <?php echo e($status == 'completed' ? 'selected' : ''); ?>>Completed
                                        </option>
                                        <option value="confirmed" <?php echo e($status == 'confirmed' ? 'selected' : ''); ?>>Confirmed
                                        </option>
                                        <option value="pending" <?php echo e($status == 'pending' ? 'selected' : ''); ?>>Pending</option>
                                        <option value="cancelled" <?php echo e($status == 'cancelled' ? 'selected' : ''); ?>>Cancelled
                                        </option>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card-premium bg-primary-grad shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="h3 mb-0 font-weight-bold"><?php echo e(number_format($totalCustomers)); ?></div>
                        <div class="mt-2 small">
                            <span class="text-white-50"><i class="fas fa-user-plus mr-1"></i> <?php echo e($newCustomersCount); ?> new
                                this month</span>
                        </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card-premium bg-success-grad shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="h3 mb-0 font-weight-bold"><?php echo e(number_format($activeCustomers)); ?></div>
                        <div class="mt-2 small">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card-premium bg-info-grad shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="h3 mb-0 font-weight-bold"><?php echo e(number_format($retentionRate, 1)); ?>%</div>
                        <div class="mt-2 small">
                            <div class="progress progress-sm bg-white-50">
                                <div class="progress-bar bg-white" role="progressbar" style="width: <?php echo e($retentionRate); ?>%">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stat-card-premium bg-purple-grad shadow h-100">
                    <div class="card-body">
                        ...
                        <div class="h3 mb-0 font-weight-bold"><?php echo e(currency_symbol()); ?><?php echo e(number_format($averageLTV, 2)); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 small">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="font-weight-bold"><?php echo e($vipCustomers); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span><i class="fas fa-circle text-primary mr-1"></i> Loyal</span>
                                <span class="font-weight-bold"><?php echo e($loyalCustomers); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span><i class="fas fa-circle text-success mr-1"></i> Regular</span>
                                <span class="font-weight-bold"><?php echo e($regularCustomers); ?></span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span><i class="fas fa-circle text-info mr-1"></i> New</span>
                                <span class="font-weight-bold"><?php echo e($newCustomers); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-lg-7 mb-4">
                <div class="card shadow h-100 border-0">
                    <div class="card-header bg-white py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <span class="badge bg-danger-subtle text-danger"><?php echo e($atRiskCustomersCount); ?> Total</span>
                    </div>
                    <div class="card-body p-0">
                        <?php if($atRiskCustomers->count() > 0): ?>
                            <div class="list-group list-group-flush">
                                <?php $__currentLoopData = $atRiskCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item at-risk-item border-0 px-4 py-3">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="font-weight-bold text-dark"><?php echo e($customer->name); ?></div>
                                                <div class="small text-muted"><?php echo e($customer->display_phone); ?></div>
                                            </div>
                                            <div class="col-auto text-right">
                                                <div class="small font-weight-bold text-danger">Last visit:
                                                    <?php echo e(\Carbon\Carbon::parse($customer->last_visit_date)->diffForHumans()); ?>

                                                </div>
                                                <div class="small text-muted">Total Spent:
                                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($customer->total_spend, 2)); ?>

                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <a href="<?php echo e(route('admin.customers.details', $customer->id)); ?>"
        ...
        <div class="card shadow mb-4 border-0">
                            ...
                            <?php $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm bg-primary-subtle text-primary rounded-circle mr-3 d-flex align-items-center justify-content-center"
                                                ...
                                                <span class="small font-weight-bold"><?php echo e(substr($customer->name, 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <div class="font-weight-bold text-dark"><?php echo e($customer->name); ?></div>
                                                <div class="text-muted small"><?php echo e($customer->display_phone); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="small fw-bold text-dark"><?php echo e(ucfirst($customer->gender ?? 'N/A')); ?></div>
                                        <div class="text-muted small">Age: <?php echo e($customer->age); ?></div>
                                    </td>
                                    <td>
                                        <div class="small fw-bold text-dark"><?php echo e(format_date($customer->created_at)); ?></div>
                                        <div class="text-muted small">First:
                                            <?php echo e($customer->first_visit_date ? format_date($customer->first_visit_date) : 'N/A'); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark border"><?php echo e($customer->total_visits); ?></span>
                                    </td>
                                    <td class="small text-muted">
                                        <?php echo e($customer->last_visit_date ? format_date($customer->last_visit_date) : 'N/A'); ?>

                                    </td>
                                    <td class="font-weight-medium">
                                        <?php echo e(format_currency($customer->total_paid)); ?>

                                    </td>
                                    <td class="font-weight-medium text-danger">
                                        <?php echo e(format_currency($customer->total_refunded)); ?>

                                    </td>
                                    <td class="font-weight-bold text-dark">
                                        <?php echo e(format_currency($customer->total_spend - $customer->total_refunded)); ?>
                                    ...
                                    <td class="pe-4 text-right">
                                        ...
                                        ?>
                                        <span class="badge <?php echo e($segmentClass); ?> border-0 px-3 py-2 rounded-pill small">
            ...
            <?php if($topCustomers->hasPages()): ?>
                <div class="card-footer bg-white border-top-0 py-3">
                    <?php echo e($topCustomers->links()); ?>
            ...
            $(document).ready(function () {
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [<?php echo e($vipCustomers); ?>, <?php echo e($loyalCustomers); ?>, <?php echo e($regularCustomers); ?>, <?php echo e($newCustomers); ?>],
                ...
                $('#exportCustomersBtn').on('click', function () {
                    ...
                    const url = new URL('<?php echo e(route("admin.reports.customers.export")); ?>', window.location.origin);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\reports\customers.blade.php ENDPATH**/ ?>