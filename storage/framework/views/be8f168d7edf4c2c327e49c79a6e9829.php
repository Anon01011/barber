            ...
            <div class="col-lg-10">
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 text-primary"><i class="fas fa-user-plus me-2"></i>Customer Information</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('admin.customers.store')); ?>" method="POST" id="customerForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="customer_id_display" class="form-label">Customer ID</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light"><i
                                                        class="fas fa-id-card text-muted"></i></span>
                                                <input type="text" class="form-control" id="customer_id_display"
                                                    value="Auto-generated" readonly disabled>
                                            </div>
                                            <small class="form-text text-muted">Will be auto-generated upon creation</small>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" id="email"
                                                    name="email" value="<?php echo e(old('email')); ?>" placeholder="john@example.com">
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <input type="hidden" name="country_code"
                                                value="<?php echo e(old('country_code', '+91')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('secondary_number')); ?>"
                                                placeholder="Alternate Contact Number">
                                            <input type="hidden" name="secondary_country_code"
                                                value="<?php echo e(old('secondary_country_code', '+91')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option value="phone" <?php echo e(old('preferred_contact', 'phone') == 'phone' ? 'selected' : ''); ?>>Phone</option>
...
unset($__errorArgs, $__bag); ?>"
                                                    id="anniversary" name="anniversary" value="<?php echo e(old('anniversary')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option value="online" <?php echo e(old('source') == 'online' ? 'selected' : ''); ?>>
                                                        Online</option>
                                                    <option value="social-media" <?php echo e(old('source') == 'social-media' ? 'selected' : ''); ?>>Social Media</option>
                                                    <option value="advertisement" <?php echo e(old('source') == 'advertisement' ? 'selected' : ''); ?>>Advertisement</option>
                                                    <option value="other" <?php echo e(old('source') == 'other' ? 'selected' : ''); ?>>
                                                        Other</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_promotional_sms"
                                                    name="send_promotional_sms" value="1" <?php echo e(old('send_promotional_sms', true) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="send_transactional_sms"
                                                    name="send_transactional_sms" value="1" <?php echo e(old('send_transactional_sms', true) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    placeholder="123 Main St, City, Country"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    placeholder="Any allergies, medical conditions, or special requirements..."><?php echo e(old('medical_notes')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\customers\create.blade.php ENDPATH**/ ?>