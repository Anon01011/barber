...
<div class="space-y-6">
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="p-6">
            <form action="<?php echo e(route('admin.employees.update', $employee)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="allow_login" name="allow_login" type="checkbox" value="1" <?php echo e(old('allow_login', $employee->user_id ? 1 : 0) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', $employee->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="login_fields" class="sm:col-span-2 grid grid-cols-1 gap-6 sm:grid-cols-2 <?php echo e(old('allow_login', $employee->user_id ? 1 : 0) ? '' : 'hidden'); ?>">
                        <!-- Password -->
                        <div>
                        ...
                        <div>
                            ...
                            <select name="role_id" id="role_id"
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->id); ?>" <?php echo e(old('role_id', ($employee->user && $employee->user->roles->first()) ? $employee->user->roles->first()->id : '') == $role->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="is_active" id="is_active" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500">
                            <option value="1" <?php echo e(old('is_active', $employee->is_active) == '1' ? 'selected' : ''); ?>>Active</option>
                            <option value="0" <?php echo e(old('is_active', $employee->is_active) == '0' ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                                    ...
                                    <div class="flex items-start service-item">
                                        <div class="flex items-center h-5">
                                            <input id="service_<?php echo e($service->id); ?>" name="services[]" type="checkbox" value="<?php echo e($service->id); ?>"
                                                   <?php echo e((is_array(old('services')) && in_array($service->id, old('services'))) || $employee->services->contains($service->id) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\employees\edit.blade.php ENDPATH**/ ?>