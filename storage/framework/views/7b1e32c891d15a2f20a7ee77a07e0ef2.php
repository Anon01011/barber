...
<head>
    ...
    <title><?php echo e($appName); ?> - The Operating System for Modern Salons</title>
    <!-- Favicon -->
    ...
    <section id="features" class="py-24 bg-slate-50 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <!-- Feature 2 -->
                <?php if(\App\Helpers\ModuleHelper::posEnabled()): ?>
                    <div
                        class="feature-card bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300">
                ...
                <!-- Feature 4 -->
                <?php if(\App\Helpers\ModuleHelper::inventoryEnabled()): ?>
                    <div
                        class="feature-card bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300">
                ...
                <!-- Feature 5 -->
                <?php if(\App\Helpers\ModuleHelper::marketingEnabled() || \App\Helpers\ModuleHelper::smsEnabled() || \App\Helpers\ModuleHelper::whatsappEnabled()): ?>
                    <div
                        class="feature-card bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300">
                        <div
                ...
                <!-- Feature 6 -->
                <?php if(\App\Helpers\ModuleHelper::reportsEnabled()): ?>
                    <div
                        class="feature-card bg-white p-8 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300">
                        <div
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <?php if(isset($plans) && $plans->count() > 0): ?>
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            class="relative bg-white rounded-3xl p-8 shadow-lg border transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 <?php echo e($plan->is_popular ? 'border-2 border-purple-500 z-10 scale-105' : 'border-slate-100'); ?>">
                            ...
                            <p class="text-slate-500 text-sm mt-2 h-10">
                                <?php echo e($plan->description ?? 'Perfect for getting started'); ?>

                            </p>
                            <div class="my-6">
                                <span
                                    class="text-4xl font-bold text-slate-900"><?php echo e(system_currency_symbol()); ?><?php echo e(number_format($plan->price, 0)); ?></span>
                                <span class="text-slate-500">/mo</span>
                            </div>
                            <a href="<?php echo e(route('saas.register', ['plan_id' => $plan->id])); ?>"
                                class="block w-full py-3 px-6 rounded-xl <?php echo e($plan->is_popular ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/30 hover:bg-purple-700' : 'bg-slate-100 text-slate-900 hover:bg-slate-200'); ?> font-bold text-center transition-all mb-8">
                                <?php echo e($plan->price == 0 ? 'Get Started Free' : 'Start Free Trial'); ?>

                            </a>
                            <ul class="space-y-4 text-sm text-slate-600">
                                <?php if($plan->features): ?>
                                    <?php $__currentLoopData = is_string($plan->features) ? json_decode($plan->features, true) : $plan->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="py-24 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <p class="text-xl text-purple-100 mb-10 max-w-2xl mx-auto leading-relaxed">Join thousands of salon owners
                who trust <?php echo e($appName); ?> to manage their business and grow their revenue.</p>
...
</html><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\welcome.blade.php ENDPATH**/ ?>