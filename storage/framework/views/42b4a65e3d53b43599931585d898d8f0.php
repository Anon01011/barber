                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-0">
                        ...
                        <div id="step-1" class="setup-step p-4 p-md-5"
                            x-data="{ gateway: '<?php echo e($settings['sms_gateway'] ?? 'twilio'); ?>' }">
                                    ...
                                    <div class="gateway-fields">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="password" id="wizard_twilio_token" class="form-control"
                                                placeholder="Enter Token" value="<?php echo e($settings['twilio_token'] ?? ''); ?>">
                                        </div>
                                        <div class="mb-4">
                                            <label class="form-label fw-bold small">From Number</label>
                                            <input type="text" id="wizard_twilio_from" class="form-control"
                                                placeholder="+1234567890" value="<?php echo e($settings['twilio_from'] ?? ''); ?>">
                                        </div>
                                    </div>
                                </template>
                                    ...
                                    <div class="gateway-fields">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" id="wizard_custom_sms_url" class="form-control"
                                                value="<?php echo e($settings['custom_sms_url'] ?? ''); ?>"
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <select id="wizard_custom_sms_method" class="form-select">
                                                    ...
                                                    <option value="GET" <?php echo e(($settings['custom_sms_method'] ?? '') === 'GET' ? 'selected' : ''); ?>>GET</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                document.getElementById('btn-test-sms').addEventListener('click', async function () {
                    ...
                    try {
                        const res = await fetch('<?php echo e(route('admin.settings.sms-setup.test')); ?>', {
                            method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\settings\sms_setup.blade.php ENDPATH**/ ?>