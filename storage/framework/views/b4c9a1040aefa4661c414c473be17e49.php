                    ...
                    <div class="card-header bg-white border-bottom-0 py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="h5 mb-0 text-gray-800"><i
                                    class="fas fa-calendar-check text-primary me-2"></i><?php echo e(__('My Appointments')); ?></h4>
                    ...
                    <div class="card-body p-3">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h5 class="mb-0 text-primary"><?php echo e($stats['total']); ?></h5>
                                            </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h5 class="mb-0 text-white"><?php echo e($stats['upcoming']); ?></h5>
                                            </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h5 class="mb-0 text-info"><?php echo e($stats['completed']); ?></h5>
                                            </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h5 class="mb-0 text-danger"><?php echo e($stats['cancelled']); ?></h5>
                                            </div>
                        ...
                        <div class="card border-0 mb-3 bg-light">
                            <div class="card-body p-2">
                                <form method="GET" action="<?php echo e(route('customer.appointments.index')); ?>"
                                    class="row g-2 align-items-center">
                                    <div class="col-md-4">
                                        <select name="status" id="status" class="form-select form-select-sm">
                                            <option value="">All Appointments</option>
                                            <option value="upcoming" <?php echo e($status == 'upcoming' ? 'selected' : ''); ?>>Upcoming
                                            </option>
                                            ...
                                            <tr class="border-bottom">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="text-muted" style="font-size: 0.75rem;">
                                                                <?php echo e($appointment->service->duration); ?> min</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-1 px-2">
                                                    <?php if($appointment->staff): ?>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?php echo e($appointment->staff->profile_photo_url); ?>"
                                                                alt="<?php echo e($appointment->staff->name); ?>" class="rounded-circle me-2"
                                                                width="24" height="24" style="object-fit: cover;">
                                                            <span style="font-size: 0.85rem;"><?php echo e($appointment->staff->name); ?></span>
                                                        </div>
                                                    <?php else: ?>
                                                        <span
                                                ...
                                                <td class="py-1 px-2">
                                                    <div style="font-size: 0.85rem;">
                                                        <div><?php echo e(format_date($appointment->start_time)); ?></div>
                                                        <div class="text-muted" style="font-size: 0.8rem;">
                                                            <?php echo e(format_time($appointment->start_time)); ?></div>
                                                    </div>
                                                </td>
                                                <td class="py-1 px-2">
                                                    <div class="d-flex flex-column gap-1">
                                                        ...
                                                        ?>
                                                        <span
                                                            class="badge d-inline-flex align-items-center bg-<?php echo e($statusColor); ?>-subtle text-<?php echo e($statusColor); ?> border border-<?php echo e($statusColor); ?>-subtle rounded-pill"
                                                            style="font-size: 0.75rem; padding: 0.25rem 0.5rem;">
                                                            <i class="fas <?php echo e($statusIcon); ?> me-1"
                                                                style="font-size: 0.7rem;"></i>
                                                            <?php echo e(ucfirst($status)); ?>

                                                        </span>
                                                        <?php if($appointment->staff_assignment_status === 'pending'): ?>
                                                            <span
                                                        ...
                                                        <?php elseif($appointment->staff_assignment_status === 'assigned'): ?>
                                                            <span
                                                ...
                                                <td class="py-1 px-2 text-end">
                                                    <div class="fw-medium" style="font-size: 0.9rem;">
                                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($appointment->amount, 2)); ?>
                                                ...
                                                <td class="py-1 px-2 text-end">
                                                    <div class="d-flex justify-content-end gap-1">
                                                        <a href="<?php echo e(route('customer.appointments.show', $appointment)); ?>"
                                                        ...
                                                        <?php if($appointment->status == 'pending'): ?>
                                                            <form method="POST"
                                                                action="<?php echo e(route('customer.appointments.destroy', $appointment)); ?>"
                                                                class="d-inline"
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if($appointment->status === 'completed' && !$appointment->rating): ?>
                                                            <button type="button" class="btn btn-sm btn-outline-warning px-2"
                                                                onclick="showRatingModal(<?php echo e($appointment->id); ?>)"
                            ...
                            <?php if($appointments->hasPages()): ?>
                                <div class="card-footer bg-white border-0 py-2 px-3">
                                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex">
                                            <?php echo e($appointments->onEachSide(1)->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\customer\appointments\index.blade.php ENDPATH**/ ?>