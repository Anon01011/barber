...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.staff.index')); ?>" class="btn btn-staff-outline">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('admin.staff.schedules')); ?>" class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label">View Type</label>
                        <select name="view_type" class="form-select" onchange="toggleDateInputs(this.value)">
                            <option value="week" <?php echo e(request('view_type', 'week') == 'week' ? 'selected' : ''); ?>>Week View
                            </option>
                            <option value="day" <?php echo e(request('view_type') == 'day' ? 'selected' : ''); ?>>Day View</option>
                            <option value="month" <?php echo e(request('view_type') == 'month' ? 'selected' : ''); ?>>Month View</option>
                            <option value="custom" <?php echo e(request('view_type') == 'custom' ? 'selected' : ''); ?>>Custom Range
                            </option>
                        </select>
                    </div>
                    <div class="col-md-3" id="singleDateField"
                        style="display: <?php echo e(request('view_type') == 'day' ? 'block' : 'none'); ?>;">
                        <label class="form-label">Select Date</label>
                        <input type="date" name="date" class="form-control"
                            value="<?php echo e(request('date', now()->format('Y-m-d'))); ?>">
                    </div>
                    <div class="col-md-3" id="monthField"
                        style="display: <?php echo e(request('view_type') == 'month' ? 'block' : 'none'); ?>;">
                        <label class="form-label">Select Month</label>
                        <input type="month" name="month" class="form-control"
                            value="<?php echo e(request('month', now()->format('Y-m'))); ?>">
                    </div>
                    <div class="col-md-3" id="startDateField"
                        style="display: <?php echo e(request('view_type') == 'custom' ? 'block' : 'none'); ?>;">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="<?php echo e(route('admin.staff.schedules')); ?>" class="btn btn-staff-outline">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <table class="table table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $period; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="text-center">
                                        <?php echo e($date->format('D')); ?><br>
                                        <small class="text-muted fw-normal"><?php echo e($date->format('d/m')); ?></small>
                                    </th>
                        ...
                        <tbody id="scheduleTableBody">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="mb-0 small"><?php echo e($member->name); ?></h6>
                                                <small class="text-muted"><?php echo e($member->roles->first()->name ?? 'N/A'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <?php $__currentLoopData = $period; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <td class="text-center small schedule-cell <?php echo e($isAbsent ? 'bg-danger-subtle' : ''); ?> <?php echo e(!$schedule ? 'empty-cell' : ''); ?>"
                                            style="vertical-align: middle; cursor: pointer;" data-staff-id="<?php echo e($member->id); ?>"
                                            data-day="<?php echo e($dayOfWeek); ?>" data-date="<?php echo e($dateKey); ?>"
                                            data-is-working="<?php echo e($schedule && $schedule->is_working ? '1' : '0'); ?>"
                                            data-start="<?php echo e($schedule && $schedule->start_time ? substr($schedule->start_time, 0, 5) : '09:00'); ?>"
                                            data-end="<?php echo e($schedule && $schedule->end_time ? substr($schedule->end_time, 0, 5) : '17:00'); ?>"
                                            data-allows-ot="<?php echo e($schedule && $schedule->allows_overtime ? '1' : '0'); ?>"
                                            data-ot-start="<?php echo e($schedule && $schedule->overtime_start ? substr($schedule->overtime_start, 0, 5) : '18:00'); ?>"
                                            data-ot-end="<?php echo e($schedule && $schedule->overtime_end ? substr($schedule->overtime_end, 0, 5) : '20:00'); ?>"
                                            onclick="editCell(this)">

                                            <?php if($isAbsent): ?>
                                                <span class="badge bg-danger text-white d-block mb-1">Absent</span>
                                                <small class="text-danger d-block"><?php echo e($absenceReason ?: 'Time Off'); ?></small>
                                            <?php elseif($schedule && $schedule->is_working): ?>
                                                <span class="badge bg-success-subtle text-white d-block mb-1">Working</span>
                                                <small class="text-muted d-block"><?php echo e(substr($schedule->start_time, 0, 5)); ?> -
                                                    <?php echo e(substr($schedule->end_time, 0, 5)); ?></small>
                                                <?php if($schedule->allows_overtime && $schedule->overtime_start && $schedule->overtime_end): ?>
                                                    <small class="text-warning d-block mt-1">
                                                        <i class="fas fa-clock"></i> OT: <?php echo e(substr($schedule->overtime_start, 0, 5)); ?> -
                                                        <?php echo e(substr($schedule->overtime_end, 0, 5)); ?>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-light"
                                            onclick="quickEditSchedule(<?php echo e($member->id); ?>, '<?php echo e($member->name); ?>')">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e(count($period) + 2); ?>" class="text-center py-4">No staff members found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <?php $__env->startComponent('components.modal', ['id' => 'quickEditModal', 'title' => 'Edit Schedule']); ?>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <div class="form-check" id="weekSpecificOption" style="display: none;">
                    ...
                    <label class="form-check-label small" for="saveWeekSpecific">
                        Apply to <strong>this week only</strong> (<?php echo e($period[0]->format('M d')); ?> -
                        <?php echo e($period[count($period) - 1]->format('M d')); ?>)
                    </label>
                </div>
                <div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            const currentViewType = '<?php echo e($viewType); ?>';
            const periodStartDate = '<?php echo e($period[0]->format("Y-m-d")); ?>';
            ...
            function saveDateSchedule(staffId, date, day) {
                ...
                fetch(`<?php echo e(url('')); ?>/<?php echo e(request()->current_salon->slug ?? ''); ?>/admin/staff/${staffId}/schedule/date`, {
                    method: 'PUT',
                    headers: {
            ...
            document.getElementById('quickEditForm').addEventListener('submit', function (e) {
                ...
                let endpoint = `<?php echo e(url('')); ?>/<?php echo e(request()->current_salon->slug ?? ''); ?>/admin/staff/${currentStaffId}/schedule`;
                let method = 'PUT';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\staff\schedules.blade.php ENDPATH**/ ?>