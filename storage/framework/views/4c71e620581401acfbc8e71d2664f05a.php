                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-home"></i></a>
                            </li>
                ...
                <div class="card stat-card border-start border-success">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e($todayBookings); ?></div>
                ...
                <div class="card stat-card border-start border-info">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e($weekBookings ?? '0'); ?></div>
                ...
                <div class="card stat-card border-start border-warning">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e($monthBookings ?? '0'); ?></div>
                ...
                <div class="card stat-card border-start border-purple">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e($upcomingBookings); ?></div>
                ...
                <div class="card stat-card border-start border-success">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e($completedBookings); ?></div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($totalBookingAmount ?? 0, 2)); ?>
                ...
                <div class="card stat-card border-start border-info">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e(currency_symbol()); ?><?php echo e(number_format($totalTips ?? 0, 2)); ?></div>
                ...
                <div class="card stat-card border-start border-success">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e(currency_symbol()); ?><?php echo e(number_format($totalEarnings ?? 0, 2)); ?>

                                </div>
                                <div class="stat-label text-muted">Total Earnings</div>
                            </div>
                            <span
                                class="badge <?php echo e(($earningsChange ?? 0) >= 0 ? 'bg-success' : 'bg-danger'); ?> bg-opacity-10 <?php echo e(($earningsChange ?? 0) >= 0 ? 'text-success' : 'text-danger'); ?>">
                                <?php echo e(($earningsChange ?? 0) >= 0 ? '+' : ''); ?><?php echo e($earningsChange ?? 0); ?>%
                                <i class="fas fa-arrow-<?php echo e(($earningsChange ?? 0) >= 0 ? 'up' : 'down'); ?> ms-1"></i>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card stat-card border-start border-warning">
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <div class="stat-value"><?php echo e(currency_symbol()); ?><?php echo e(number_format($avgBookingValue ?? 0, 2)); ?>
                            ...
                            <div class="text-end">
                                <small class="text-muted d-block">Tip:
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($avgTipValue ?? 0, 2)); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="<?php echo e(route('admin.services.categories.index')); ?>" class="btn btn-sm btn-link">View
                                All</a>
                        </div>
                        <div class="chart-container" style="height: 250px;">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $topServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-soft-primary text-primary"><?php echo e($service->booking_count); ?></span>
                                            </td>
                                            <td class="fw-semibold">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($service->price * $service->booking_count, 2)); ?>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    ?>
                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                                        <?php if($i <= $flooredRating): ?>
                                                            <i class="fas fa-star text-warning small"></i>
                                                        <?php elseif($i == $flooredRating + 1 && $hasHalfStar): ?>
                                                            <i class="fas fa-star-half-alt text-warning small"></i>
                                                        <?php else: ?>
                                                            <i class="far fa-star text-light small"></i>
                                                        <?php endif; ?>
                                                    <?php endfor; ?>
                                                    <span class="ms-1">(<?php echo e(number_format($rating, 1)); ?>)</span>
                                                </div>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-light view-service-details"
                                                    ...
                                                    data-service-category="<?php echo e($service->category->name ?? 'General'); ?>"
                                                    data-service-price="<?php echo e($service->price); ?>"
                                                    data-service-bookings="<?php echo e($service->booking_count); ?>"
                                                    data-service-rating="<?php echo e($service->average_rating ?? 0); ?>">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="<?php echo e(route('admin.staff.index')); ?>" class="btn btn-sm btn-link">View All</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover table-centered mb-0">
                                <thead class="table-light">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $topEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-xs me-2">
                                                        <img src="<?php echo e($employee->avatar_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($employee->name) . '&background=random'); ?>"
                                                            alt="<?php echo e($employee->name); ?>" class="rounded-circle"
                                                            onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name='+encodeURIComponent('<?php echo e($employee->name[0] ?? 'U'); ?>')+''">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e($employee->name); ?></h6>
                                                        <small
                                                            class="text-muted"><?php echo e($employee->position ?? 'Employee'); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center"><?php echo e($employee->booking_count); ?></td>
                                            <td class="text-nowrap">
                                                <?php if(isset($employee->booking_amount) && $employee->booking_amount > 0): ?>
                                                    <div class="fw-semibold">
                                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($employee->booking_amount, 2)); ?>

                                                    </div>
                                                    <small class="text-muted">Tip:
                                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($employee->tips, 2)); ?></small>
                                                <?php else: ?>
                                                    <?php echo e(currency_symbol()); ?>0.00
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-light view-employee-details"
                                                    ...
                                                    data-employee-id="<?php echo e($employee->staff_id); ?>"
                                                    data-employee-name="<?php echo e($employee->name); ?>"
                                                    data-employee-position="<?php echo e($employee->position ?? 'Employee'); ?>"
                                                    data-employee-avatar="<?php echo e($employee->avatar_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($employee->name) . '&background=random'); ?>"
                                                    data-employee-bookings="<?php echo e($employee->booking_count); ?>"
                                                    data-employee-earnings="<?php echo e($employee->revenue ?? 0); ?>"
                                                    data-employee-rating="<?php echo e($employee->rating ?? 0); ?>">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                            </td>
                                        </tr>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="<?php echo e(route('admin.customers.index')); ?>" class="btn btn-sm btn-link">View All</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover table-centered mb-0">
                                <thead class="table-light">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-xs me-2">
                                                        <span class="avatar-title bg-soft-info text-info rounded-circle">
                                                            <?php echo e(substr($customer->customer->full_name ?? 'C', 0, 1)); ?>

                                                        </span>
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e($customer->customer->full_name ?? 'Unknown'); ?></h6>
                                                        <small
                                                            class="text-muted"><?php echo e($customer->customer->display_phone ?? 'No Phone'); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-soft-info text-info"><?php echo e($customer->booking_count); ?></span>
                                            </td>
                                            <td class="fw-semibold">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($customer->total_booking_amount, 2)); ?>

                                            </td>
                                            <td class="text-success">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($customer->total_tips, 2)); ?>
                                            ...
                                            <td>
                                                <button type="button" onclick="viewCustomer(<?php echo e($customer->customer_id); ?>)"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-sm btn-link">View Dashboard</a>
                        </div>
                        <div class="table-responsive">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = ($recentReviews ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-xs me-2">
                                                        <span class="avatar-title bg-soft-primary text-primary rounded-circle">
                                                            <?php echo e(substr($review->customer_name, 0, 1)); ?>

                                                        </span>
                                                    </div>
                                                    <div><?php echo e($review->customer_name); ?></div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-truncate" style="max-width: 200px;"
                                                ...
                                                <?php echo e(Str::limit($review->comment ?? 'No comment', 30)); ?>

                                            </td>
                                            <td><?php echo e($review->created_at->diffForHumans()); ?></td>
                                            <td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($bookingCompletionRate ?? 0); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-success" role="progressbar"
                                    style="width: <?php echo e($bookingCompletionRate ?? 0); ?>%"
                                    aria-valuenow="<?php echo e($bookingCompletionRate ?? 0); ?>" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($customerSatisfaction ?? 0); ?>/5</span>
                            </div>
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-info" role="progressbar"
                                    style="width: <?php echo e(($customerSatisfaction ?? 0) * 20); ?>%"
                                    aria-valuenow="<?php echo e($customerSatisfaction ?? 0); ?>" aria-valuemin="0" aria-valuemax="5">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($repeatCustomerRate ?? 0); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-warning" role="progressbar"
                                    style="width: <?php echo e($repeatCustomerRate ?? 0); ?>%"
                                    aria-valuenow="<?php echo e($repeatCustomerRate ?? 0); ?>" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span
                                    class="fw-semibold"><?php echo e(currency_symbol()); ?><?php echo e(number_format($avgBookingValue ?? 0, 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($peakHours ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($busiestDay ?? 'N/A'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold"><?php echo e($cancellationRate ?? 0); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar bg-danger" role="progressbar"
                                    style="width: <?php echo e($cancellationRate ?? 0); ?>%"
                                    aria-valuenow="<?php echo e($cancellationRate ?? 0); ?>" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="p-2 border rounded">
                                        <h6 class="mb-0">
                                            <?php echo e(currency_symbol()); ?><?php echo e(number_format($avgBookingValue ?? 0, 2)); ?>
                                ...
                                <div class="col-6">
                                    <div class="p-2 border rounded">
                                        <h6 class="mb-0"><?php echo e($peakHours ?? 'N/A'); ?></h6>
                                        <p class="text-muted mb-0 small">Peak Hours</p>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-2 border rounded">
                                        <h6 class="mb-0"><?php echo e($busiestDay ?? 'N/A'); ?></h6>
                                        <p class="text-muted mb-0 small">Busiest Day</p>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-2 border rounded">
                                        <h6 class="mb-0 text-danger"><?php echo e($cancellationRate ?? 0); ?>%</h6>
        ...
        <?php $__env->startPush('scripts'); ?>
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                            ...
                            datasets: [
                                {
                                    ...
                                    data: <?php echo json_encode($monthlyBookingAmount ?? [], 15, 512) ?>,
                                ...
                                {
                                    label: 'Tips',
                                    data: <?php echo json_encode($monthlyTips ?? [], 15, 512) ?>,
                    ...
                    const serviceData = <?php echo json_encode($bookingsByService ?? [], 15, 512) ?>;
        ...
        <?php $__env->startPush('scripts'); ?>
            ...
            <script>
                ...
                const statusChart = new Chart(statusCtx, {
                    type: 'doughnut',
                    data: {
                        labels: <?php echo json_encode($bookingsByStatus->keys()->map(fn($status) => ucfirst($status))->toArray(), 15, 512) ?>,
                        datasets: [{
                            data: <?php echo json_encode($bookingsByStatus->values()->toArray(), 15, 512) ?>,
                            backgroundColor: [
                                '#4e73df',
                                '#1cc88a',
                                '#36b9cc',
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card h-100">
                                            <div class="card-body text-center">
                                                ...
                                                <h3 id="totalEarnings" class="mb-0"><?php echo e(currency_symbol()); ?>0.00</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="p-3 bg-light rounded-3 text-center h-100 border border-light">
                                    ...
                                    <h4 id="servicePrice" class="mb-0 fw-bold text-dark"><?php echo e(currency_symbol()); ?>0.00</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="p-3 bg-light rounded-3 text-center h-100 border border-light">
                                    ...
                                    <h4 id="serviceRevenue" class="mb-0 fw-bold text-dark"><?php echo e(currency_symbol()); ?>0.00</h4>
                                </div>
                            </div>
...
<?php endif; ?>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\bookings\stats.blade.php ENDPATH**/ ?>