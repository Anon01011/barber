    ...
    <div class="container-fluid ">
        ...
        <div class="card shadow-sm mb-4 border-0">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.modules.update')); ?>" method="POST" id="modulesForm">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>

                    <div class="row">
                        <?php $__currentLoopData = $availableModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-4 col-md-6 mb-4">
                                <div class="card h-100 module-card <?php echo e(isset($enabledModules[$key]) && $enabledModules[$key] ? 'border-primary-left' : 'border-gray-left'); ?> shadow-sm transition-all border-0">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <div class="icon-circle shadow-sm <?php echo e(isset($enabledModules[$key]) && $enabledModules[$key] ? 'bg-primary text-white' : 'bg-light text-muted'); ?>">
                                                    <i class="fas <?php echo e($module['icon']); ?>"></i>
                                                </div>
                                            </div>
                                            <div class="col ps-0">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <h6 class="mb-0 fw-bold text-dark"><?php echo e($module['name']); ?></h6>
                                                    <div class="form-check form-switch p-0">
                                                        <input class="form-check-input module-toggle ms-0" 
                                                               type="checkbox" 
                                                               role="switch"
                                                               id="module_<?php echo e($key); ?>" 
                                                               name="enabled_modules[<?php echo e($key); ?>]" 
                                                               value="1"
                                                               <?php echo e((isset($enabledModules[$key]) && $enabledModules[$key]) ? 'checked' : ''); ?>>
                                                    </div>
                                                </div>
                                                <p class="text-muted small mb-3 mt-1 line-clamp"><?php echo e($module['description']); ?></p>

                                                <div class="d-flex align-items-center justify-content-between bg-light rounded-pill px-3 py-1">
                                                    <label for="status_<?php echo e($key); ?>" class="label-tiny text-uppercase mb-0">Status:</label>
                                                    <select class="form-select status-select-minimal border-0 bg-transparent py-0 h-auto" id="status_<?php echo e($key); ?>" name="module_statuses[<?php echo e($key); ?>]">
                                                        <option value="stable" <?php echo e(($moduleStatuses[$key] ?? 'stable') == 'stable' ? 'selected' : ''); ?>>Stable</option>
                                                        <option value="beta" <?php echo e(($moduleStatuses[$key] ?? 'stable') == 'beta' ? 'selected' : ''); ?>>Beta</option>
                                                        <option value="alpha" <?php echo e(($moduleStatuses[$key] ?? 'stable') == 'alpha' ? 'selected' : ''); ?>>Alpha</option>
                                                        <option value="development" <?php echo e(($moduleStatuses[$key] ?? 'stable') == 'development' ? 'selected' : ''); ?>>In-Dev</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer bg-white py-2 border-top-0 d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="status-indicator-dot <?php echo e(isset($enabledModules[$key]) && $enabledModules[$key] ? 'bg-success' : 'bg-danger'); ?>"></span>
                                            <small class="module-status-label fw-bold <?php echo e(isset($enabledModules[$key]) && $enabledModules[$key] ? 'text-success' : 'text-danger'); ?> text-uppercase" style="font-size: 0.65rem;">
                                                <?php echo e((isset($enabledModules[$key]) && $enabledModules[$key]) ? 'Online' : 'Offline'); ?>

                                            </small>
                                        </div>
                                        <?php $stage = $moduleStatuses[$key] ?? 'stable'; ?>
                                        <span class="badge <?php echo e($stage == 'stable' ? 'bg-success-light text-success' : ($stage == 'beta' ? 'bg-warning-light text-warning' : 'bg-info-light text-info')); ?> border-0 px-2 py-1" style="font-size: 0.6rem;">
                                            <?php echo e(strtoupper($stage)); ?>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\super-admin\modules\index.blade.php ENDPATH**/ ?>