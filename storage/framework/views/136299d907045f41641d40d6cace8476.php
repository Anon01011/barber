            ...
            <div class="col-md-6">
                <div class="form-check form-switch custom-switch pt-4">
                    <input class="form-check-input" type="checkbox" name="notify_new_booking" value="1"
                        id="notify_new_booking" <?php echo e(($settings['notify_new_booking'] ?? true) ? 'checked' : ''); ?>>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch custom-switch pt-4">
                    <input class="form-check-input" type="checkbox" name="notify_cancellation" value="1"
                        id="notify_cancellation" <?php echo e(($settings['notify_cancellation'] ?? true) ? 'checked' : ''); ?>>
                    <label class="form-check-label fw-semibold small text-uppercase text-secondary"
            ...
            <div class="col-md-6">
                <div class="form-check form-switch custom-switch pt-4">
                    <input class="form-check-input" type="checkbox" name="notify_low_stock" value="1"
                        id="notify_low_stock" <?php echo e(($settings['notify_low_stock'] ?? true) ? 'checked' : ''); ?>>
                    <label class="form-check-label fw-semibold small text-uppercase text-secondary"
            ...
            <div class="col-md-6">
                <div class="form-check form-switch custom-switch pt-4">
                    <input class="form-check-input" type="checkbox" name="notify_new_customer" value="1"
                        id="notify_new_customer" <?php echo e(($settings['notify_new_customer'] ?? false) ? 'checked' : ''); ?>>
                    <label class="form-check-label fw-semibold small text-uppercase text-secondary"
        ...
        <div class="row g-4 border-top pt-4">
            <div class="col-md-6">
                ...
                <input type="email" name="notification_email" class="form-control"
                    value="<?php echo e($settings['notification_email'] ?? ''); ?>" placeholder="alerts@salon.com">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <div class="input-group-text bg-white">
                        <input class="form-check-input mt-0" type="checkbox" name="daily_summary_enabled" value="1" <?php echo e(($settings['daily_summary_enabled'] ?? false) ? 'checked' : ''); ?>>
                    </div>
                    <input type="time" name="daily_summary_time" class="form-control"
                        value="<?php echo e($settings['daily_summary_time'] ?? '18:00'); ?>">
                </div>
...
<?php if(auth()->user()->salon->canUseFeature('SMS Notifications') && \App\Helpers\ModuleHelper::smsEnabled()): ?>
    <div class="settings-section-card" x-data="{ gateway: '<?php echo e($settings['sms_gateway'] ?? 'twilio'); ?>' }">
        <div class="settings-section-header">
            ...
            <div class="row g-4 align-items-center mb-4">
                <div class="col-md-6">
                    <div class="form-check form-switch custom-switch">
                        <input class="form-check-input" type="checkbox" name="enable_sms" value="1" id="enable_sms" <?php echo e(($settings['enable_sms'] ?? false) ? 'checked' : ''); ?>>
                        <label class="form-check-label fw-semibold small text-uppercase text-secondary"
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="twilio_sid" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['twilio_sid'] ?? ''); ?>" placeholder="AC...">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="password" name="twilio_token" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['twilio_token'] ?? ''); ?>" placeholder="••••••••">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="text" name="twilio_from" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['twilio_from'] ?? ''); ?>" placeholder="+1...">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="vonage_api_key" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['vonage_api_key'] ?? ''); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="password" name="vonage_api_secret" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['vonage_api_secret'] ?? ''); ?>" placeholder="••••••••">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="text" name="vonage_from" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['vonage_from'] ?? ''); ?>" placeholder="SalonName">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="password" name="messagebird_access_key" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['messagebird_access_key'] ?? ''); ?>" placeholder="••••••••">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="text" name="messagebird_originator" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['messagebird_originator'] ?? ''); ?>" placeholder="SalonName">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-9">
                            ...
                            <input type="url" name="custom_sms_url" class="form-control text-xs"
                                value="<?php echo e($settings['custom_sms_url'] ?? ''); ?>" placeholder="https://api.gateway.com/send">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                                    class="fas fa-exchange-alt text-warning me-2"></i>Method</label>
                            <select name="custom_sms_method" class="form-select text-xs">
                                <option value="POST" <?php echo e(($settings['custom_sms_method'] ?? 'POST') === 'POST' ? 'selected' : ''); ?>>POST</option>
                                <option value="GET" <?php echo e(($settings['custom_sms_method'] ?? '') === 'GET' ? 'selected' : ''); ?>>
                                    GET</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            ...
                            <textarea name="custom_sms_headers" class="form-control font-monospace text-xs" rows="2"
                                placeholder='{"Authorization": "Bearer ..."}'><?php echo e($settings['custom_sms_headers'] ?? ''); ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <textarea name="custom_sms_payload" class="form-control font-monospace text-xs" rows="2"
                                placeholder='{"route": "promo"}'><?php echo e($settings['custom_sms_payload'] ?? ''); ?></textarea>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                                    class="fas fa-tag text-info me-2"></i>To Param</label>
                            <input type="text" name="custom_sms_to_key" class="form-control text-xs"
                                value="<?php echo e($settings['custom_sms_to_key'] ?? 'to'); ?>">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <input type="text" name="custom_sms_message_key" class="form-control text-xs"
                                value="<?php echo e($settings['custom_sms_message_key'] ?? 'message'); ?>">
                        </div>
                    </div>
                </div>
            </div>
...
<?php if(auth()->user()->salon->canUseFeature('WhatsApp Notifications') && \App\Helpers\ModuleHelper::whatsappEnabled()): ?>
    <div class="settings-section-card" x-data="{ wgateway: '<?php echo e($settings['whatsapp_gateway'] ?? 'twilio'); ?>' }">
        <div class="settings-section-header">
                ...
                <div class="col-md-6">
                    <div class="form-check form-switch custom-switch-success">
                        <input class="form-check-input" type="checkbox" name="enable_whatsapp" value="1"
                            id="enable_whatsapp" <?php echo e(($settings['enable_whatsapp'] ?? false) ? 'checked' : ''); ?>>
                        <label class="form-check-label fw-semibold small text-uppercase text-secondary"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="whatsapp_twilio_from" class="form-control font-monospace text-xs"
                                value="<?php echo e($settings['whatsapp_twilio_from'] ?? ''); ?>" placeholder="whatsapp:+...">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="whatsapp_custom_headers" class="form-control font-monospace text-xs" rows="2"
                                placeholder='{"X-API-KEY": "..."}'><?php echo e($settings['whatsapp_custom_headers'] ?? ''); ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
                            ...
                            <textarea name="whatsapp_custom_payload" class="form-control font-monospace text-xs" rows="2"
                                placeholder='{"message": "{message}", "to": "{to}"}'><?php echo e($settings['whatsapp_custom_payload'] ?? ''); ?></textarea>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-uppercase text-secondary"><i
...
</style><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\settings\partials\notifications.blade.php ENDPATH**/ ?>