...
<?php $__env->startPush('scripts'); ?>
    <script>
        function viewCustomer(id) {
            ...
            // Fetch customer data
            fetch(`<?php echo e(route('admin.customers.index')); ?>/${id}`, {
                headers: {
                ...
                .then(data => {
                    ...
                    if (data.success && data.data) {
                        ...
                        if (viewAllBtn) {
                            viewAllBtn.href = `<?php echo e(route('admin.customers.index')); ?>/${customer.id}/details`;
...
<?php $__env->stopPush(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\components\modals\view-customer.blade.php ENDPATH**/ ?>