        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <h2 class="h3 fw-bold text-gray-800 mb-1">Create New Branch</h2>
                        <p class="text-muted mb-0">Add a new location to your salon network.</p>
                    </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light border-bottom-0 py-3">
                        ...
                        <small class="text-muted">Please provide the details for the new branch.</small>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            placeholder="123 Main St, City, State, Zip"><?php echo e(old('address')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\branches\create.blade.php ENDPATH**/ ?>