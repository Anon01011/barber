            ...
            <div class="d-flex gap-2">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.sales.export')); ?>"><i
                                    class="fas fa-file-excel text-success me-2"></i>Sales Report</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.appointments.export')); ?>"><i
                                    class="fas fa-file-excel text-info me-2"></i>Appointments</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.staff.export')); ?>"><i
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['today_revenue'], 2)); ?>

                                </div>
                                <div class="x-small text-muted mt-1">
                                    <i class="fas fa-calendar-day me-1"></i><?php echo e($stats['today_bookings']); ?> Bookings
                                </div>
                            </div>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['today_refunds'] ?? 0, 2)); ?>

                                </div>
                                <div class="x-small text-muted mt-1">
                                    Net: <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['today_net_refunds'] ?? 0, 2)); ?>

                                    <?php if(($stats['today_refund_fees'] ?? 0) > 0): ?>
                                        <span class="text-info ms-1">(Fees: <?php echo e(number_format($stats['today_refund_fees'], 2)); ?>)</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['month_revenue'], 2)); ?>

                                </div>
                                <div
                                    class="x-small mt-1 <?php echo e($stats['revenue_growth'] >= 0 ? 'text-success' : 'text-danger'); ?>">
                                    <i class="fas fa-arrow-<?php echo e($stats['revenue_growth'] >= 0 ? 'up' : 'down'); ?> me-1"></i>
                                    <?php echo e(number_format(abs($stats['revenue_growth']), 1)); ?>%
                                </div>
                            </div>
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800">
                                    <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['month_refunds'] ?? 0, 2)); ?>

                                </div>
                                <div class="x-small text-muted mt-1">
                                    Net: <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['month_net_refunds'] ?? 0, 2)); ?>

                                    <?php if(($stats['month_refund_fees'] ?? 0) > 0): ?>
                                        <span class="text-info ms-1">(Fees: <?php echo e(number_format($stats['month_refund_fees'], 2)); ?>)</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="rounded-circle bg-danger bg-opacity-10 p-2">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="h5 mb-0 fw-bold text-gray-800"><?php echo e($stats['month_bookings']); ?></div>
                                <div class="x-small text-muted mt-1">
                                    Bookings this month
                                </div>
                            </div>
                ...
                <div class="card border-0 shadow-sm h-100 bg-gradient-primary text-white">
                    <div class="card-body p-2 d-flex flex-column justify-content-center">
                        ...
                        <div class="d-grid gap-1">
                            <a href="<?php echo e(route('admin.reports.sales')); ?>" class="btn btn-xs btn-light text-primary fw-bold" style="font-size: 0.7rem; padding: 2px 5px;">
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            ...
                            <a href="<?php echo e(route('admin.reports.staff')); ?>"
                                class="list-group-item list-group-item-action py-3">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $stats['top_services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="fw-bold"><?php echo e($service->name); ?></td>
                                            <td class="text-end"><span
                                                    class="badge bg-info bg-opacity-10 text-info"><?php echo e($service->count); ?></span>
                                            </td>
                                            <td class="text-end fw-bold">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($service->revenue, 2)); ?></td>
                                        </tr>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $stats['top_staff']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="fw-bold"><?php echo e($staff->name); ?></td>
                                            <td class="text-end fw-bold text-success">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($staff->revenue, 2)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $stats['recent_activity']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="small">
                                                <div class="fw-bold">
                                                    <?php echo e(\Carbon\Carbon::parse($activity->date)->format('M d, Y')); ?></div>
                                                <div class="text-muted">
                                                    <?php echo e(\Carbon\Carbon::parse($activity->date)->format('h:i A')); ?></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="fw-bold"><?php echo e($activity->customer); ?></td>
                                            <td class="text-end fw-bold">
                                                <?php echo e(currency_symbol()); ?><?php echo e(number_format($activity->amount, 2)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            $(document).ready(function () {
                ...
                const trendData = <?php echo json_encode($stats['monthly_trend'], 15, 512) ?>;
                            ...
                            y: {
                                ...
                                ticks: {
                                    callback: function (value) {
                                        return '<?php echo e(currency_symbol()); ?>' + value.toLocaleString();
                                    }
                                }
                            }
                        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\reports\index.blade.php ENDPATH**/ ?>