...
<head>
    ...
    <title><?php echo e($status === 'pending' ? 'Pending Approval' : 'Application Status'); ?> - <?php echo e(config('app.name')); ?></title>
        ...
        <div class="auth-left">
            <div class="auth-left-content">
                ...
                <p style="font-size: 1rem; opacity: 0.9; margin-bottom: 2rem; line-height: 1.5;">
                    <?php if($status === 'pending'): ?>
                        Thank you for choosing <?php echo e(config('app.name')); ?>. Your salon registration is under review.
                    <?php else: ?>
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <div class="feature-item">
                        <div class="feature-icon"><?php echo e($status === 'pending' ? '⏳' : '✗'); ?></div>
                        <span><?php echo e($status === 'pending' ? 'Awaiting Admin Approval' : 'Review Completed'); ?></span>
                    </div>
                    <?php if($status === 'pending'): ?>
                        <div class="feature-item">
                            <div class="feature-icon">📧</div>
            ...
            <div class="auth-card">
                ...
                <div class="info-card">
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo e($salon->name); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Owner Email</span>
                        <span class="info-value"><?php echo e($salon->email); ?></span>
                    </div>
                    <?php if($subscription): ?>
                        <div class="info-row">
                            <span class="info-label">Plan</span>
                            <span class="info-value"><?php echo e($subscription->plan->name ?? 'N/A'); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Payment Method</span>
                            <span class="info-value">
                                <?php echo e($subscription->payment_method ? ucfirst($subscription->payment_method) : 'Trial'); ?>

                            </span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Status</span>
                            <span class="info-value" style="color: <?php echo e($status === 'pending' ? '#92400e' : '#991b1b'); ?>;">
                ...
                <?php else: ?>
                    <div
                        ...
                        <p style="color: #991b1b; font-size: 0.875rem; margin: 0; line-height: 1.5;">
                            ...
                            Please contact our support team at <?php echo e(config('mail.from.address')); ?> for assistance with your
                            application.
                        </p>
                    </div>
                <?php endif; ?>
                ...
                <div class="action-buttons">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('logout')); ?>" style="flex: 1; margin: 0;">
                        <?php echo csrf_field(); ?>
        ...
        <script>
            ...
            async function initiatePayment(planId) {
                ...
                try {
                    ...
                    const response = await fetch('<?php echo e(route('admin.saas.payment.create-intent', ['salon_slug' => $salon->slug])); ?>', {
                        method: 'POST',
                        headers: {
...
</html><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\saas\pending-approval.blade.php ENDPATH**/ ?>