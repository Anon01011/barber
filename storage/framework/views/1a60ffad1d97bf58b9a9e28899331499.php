<?php $__env->startSection('title', 'Barbershop POS'); ?>

<?php $__env->startPush('styles'); ?>
    <?php
        $themeColor = app(\App\Services\SettingsService::class)->getThemeColor();
        $colorMap = [
            'pink' => '#e83e8c',
            'blue' => '#0d6efd',
            'purple' => '#6f42c1',
        ...
        $themeHex = $colorMap[$themeColor] ?? '#0d6efd';
        $themeRgb = $colorRgbMap[$themeColor] ?? '13, 110, 253';
    ?>
    <style>
        :root {
            --theme-color: <?php echo e($themeHex); ?> !important;
            --theme-color-rgb: <?php echo e($themeRgb); ?> !important;
            --theme-color-light: rgba(<?php echo e($themeRgb); ?>, 0.08) !important;
            --theme-color-hover: rgba(<?php echo e($themeRgb); ?>, 0.15) !important;
        }

        /* Premium Vintage Barbershop Light Theme Overrides */
        body {
        ...
        .card {
            ...
            color: #2C2621 !important;
            box-shadow: 0 4px 12px rgba(44, 38, 33, 0.05) !important;
        }
        ...
        .table th {
            ...
            box-shadow: inset 0 -1px 0 #E6DFD5 !important;
        }
        ...
        /* Grid Section responsive CSS Grid overrides */
        .items-grid-container {
            ...
            box-shadow: inset 0 2px 5px rgba(44, 38, 33, 0.02) !important;
        }
        ...
        /* Grid Item Card styling - Centered, touch-friendly tiles */
        .item-card {
            user-select: none;
            cursor: pointer;
            position: relative;
            ...
            box-shadow: 0 2px 4px rgba(44, 38, 33, 0.02) !important;
        ...
        /* Specific Hover states based on item types */
        .item-card[data-type="service"]:hover {
            border-color: var(--theme-color) !important;
            background-color: var(--theme-color-light) !important;
            transform: translateY(-2px);
            box-shadow: 0 6px 12px rgba(var(--theme-color-rgb), 0.08) !important;
        }

        .item-card[data-type="service"]:active {
            background-color: var(--theme-color-hover) !important;
        }

        .item-card[data-type="product"]:hover {
        ...
        .item-card[data-type="product"]:active {
            background-color: #D1FAE5 !important;
        }

        .item-card[data-type="package"]:hover {
        ...
        .item-card[data-type="package"]:active {
            background-color: #DBEAFE !important;
        }

        .item-card[data-type="membership"]:hover {
        ...
        .item-card[data-type="membership"]:active {
            background-color: #F3E8FF !important;
        }

        /* Tactical Haptic scale down on active touch */
        .item-card:active {
        ...
        /* Custom inline helper styles to guarantee Bootstrap compatibility */
        ...
        /* Elegant modern input groups style */
        .input-group {
            border-radius: 8px !important;
            overflow: hidden !important;
            border: 1px solid #D3C9BC !important;
            background-color: #FFFFFF !important;
            transition: all 0.2s ease !important;
            box-shadow: 0 2px 4px rgba(44, 38, 33, 0.01) !important;
        }

        .input-group:focus-within {
            border-color: var(--theme-color) !important;
            box-shadow: 0 0 0 0.25rem rgba(var(--theme-color-rgb), 0.15) !important;
        }
        ...
        .form-select:focus {
            ...
            color: #2C2621 !important;
            box-shadow: 0 0 0 0.25rem rgba(180, 83, 9, 0.15) !important;
        }
        ...
        .dropdown-menu {
            ...
            box-shadow: 0 10px 25px -5px rgba(44, 38, 33, 0.1) !important;
        ...
        /* Buttons overrides to Amber/Gold */
        .btn-primary {
        ...
        .btn-outline-success.active {
            ...
            border-color: #059669 !important;
            color: #FFFFFF !important;
            box-shadow: 0 4px 6px -1px rgba(5, 150, 105, 0.15) !important;
        }
        ...
        .btn-outline-secondary.active {
            ...
            border-color: #7C3AED !important;
            color: #FFFFFF !important;
            box-shadow: 0 4px 6px -1px rgba(124, 58, 237, 0.15) !important;
        }
        ...
        .service-card {
            box-shadow: 0 2px 4px rgba(44, 38, 33, 0.02);
            user-select: none;
        ...
        .service-card.selected {
            border-color: #B45309 !important;
            background-color: #FFFBEB !important;
            box-shadow: 0 4px 12px -2px rgba(180, 83, 9, 0.15) !important;
        }
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-3 py-1 bg-light d-flex flex-column"
        style="height: calc(100vh - var(--header-height) - 15px); overflow: hidden;">
        <!-- Page Header -->
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-2 pb-2 border-bottom">
            <div class="mb-1 mb-md-0">
                <h1 class="fs-5 mb-0 fw-semibold">
                    <i class="fas fa-scissors me-2 text-warning animate-pulse"></i>Barbershop POS Terminal
                </h1>
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-md-end gap-2">
                    <?php if(optional(auth()->user()->salon)->business_type === 'both'): ?>
                        <a href="<?php echo e(route('admin.pos.index', ['view' => 'salon'])); ?>" class="btn btn-sm btn-outline-warning">
                            <i class="fas fa-exchange-alt me-1"></i> Switch to Salon POS
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.pos.analytics.index')); ?>" class="btn btn-sm btn-outline-info">
        ...
        <div class="row g-2 pb-2 pos-main-row flex-grow-1" style="min-height: 0; margin-top: 0; overflow: hidden;">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm" style="height: 100%; display: flex; flex-direction: column; overflow: hidden;">
                    ...
                    <div class="card-header bg-white py-2 border-bottom">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                            <h5 class="card-title mb-0 fw-semibold">
                                <i class="fas fa-scissors me-2 text-warning"></i>Haircuts & Barber Services
                            </h5>
                    ...
                    <div class="card-body p-3 flex-grow-1 d-flex flex-column" style="overflow: hidden; min-height: 0;">
                        <!-- Tabs & Live Filter Search Bar Row -->
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex flex-wrap gap-2" id="posActionButtons">
                                <button class="btn btn-outline-primary active" data-form="services">
                                    <i class="fas fa-scissors me-1"></i> Services
                                </button>
                                <?php if(optional(auth()->user()->salon)->canUseFeature('Inventory Management')): ?>
                                    <button class="btn btn-outline-success" data-form="products">
                                        <i class="fas fa-box me-1"></i> Products
                                    </button>
                                <?php endif; ?>
                                <?php if(optional(auth()->user()->salon)->canUseFeature('Packages')): ?>
                                    <button class="btn btn-outline-info" data-form="packages">
                                        <i class="fas fa-gift me-1"></i> Packages
                                    </button>
                                <?php endif; ?>
                                <?php if(optional(auth()->user()->salon)->canUseFeature('Memberships')): ?>
                            ...
                            <!-- Real-time Local grid item filter search bar -->
                            <div class="position-relative" style="width: 220px;">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light border-end-0" style="padding: 0.25rem 0.5rem;">
                                        <i class="fas fa-filter text-muted" style="font-size: 0.75rem;"></i>
                                    </span>
                                    <input type="text" id="gridFilterInput"
                                        class="form-control form-control-sm border-start-0" placeholder="Filter items..."
                                        autocomplete="off">
                                </div>
                            </div>
                        </div>

                        <div class="items-grid-container border rounded p-3 mb-3 bg-white">

                            <!-- Services Grid Section -->
                            <div class="grid-section" id="servicesGridSection">
                                <div class="row g-2">
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12 col-sm-6 col-md-4 grid-item-wrapper"
                                            data-name="<?php echo e(strtolower($service->name)); ?>">
                                            <div class="item-card border rounded cursor-pointer transition-all h-100"
                                                data-type="service" data-id="<?php echo e($service->id); ?>"
                                                data-name="<?php echo e($service->name); ?>" data-price="<?php echo e($service->price); ?>">
                                                <div class="fw-bold text-dark text-truncate w-100" style="font-size: 0.825rem;"
                                                    title="<?php echo e($service->name); ?>">
                                                    <?php echo e($service->name); ?>

                                                </div>
                                                <div class="text-theme fw-bold text-xs mt-1">
                                                    <?php echo e(format_currency($service->price)); ?>
                            ...
                            <div class="grid-section d-none" id="productsGridSection">
                                <div class="row g-2">
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12 col-sm-6 col-md-4 grid-item-wrapper"
                                            data-name="<?php echo e(strtolower($product->name)); ?>">
                                            <div class="item-card border rounded cursor-pointer transition-all h-100"
                                                data-type="product" data-id="<?php echo e($product->id); ?>"
                                                data-name="<?php echo e($product->name); ?>" data-price="<?php echo e($product->selling_price); ?>">
                                                <div class="fw-bold text-dark text-truncate w-100" style="font-size: 0.825rem;"
                                                    title="<?php echo e($product->name); ?>">
                                                    <?php echo e($product->name); ?>

                                                </div>
                                                <div class="text-emerald-800 fw-bold text-xs mt-1">
                            ...
                            <div class="grid-section d-none" id="packagesGridSection">
                                <div class="row g-2">
                                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-12 col-sm-6 col-md-4 grid-item-wrapper"
                                            data-name="<?php echo e(strtolower($package->name)); ?>">
                                            <div class="item-card border rounded cursor-pointer transition-all h-100"
                                                data-type="package" data-id="<?php echo e($package->id); ?>"
                                                data-name="<?php echo e($package->name); ?>" data-price="<?php echo e($package->price); ?>">
                                                <div class="fw-bold text-dark text-truncate w-100" style="font-size: 0.825rem;"
                                                    title="<?php echo e($package->name); ?>">
                                                    <?php echo e($package->name); ?>

                                                </div>
                                                <div class="text-blue-800 fw-bold text-xs mt-1">
                                                    <?php echo e(format_currency($package->price)); ?>
                            ...
                            <div class="grid-section d-none" id="membershipsGridSection">
                                <div class="row g-2">
                                    <?php $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $membershipPrice = $membership->calculateTotalMembershipPrice();
                                        ?>
                                        <div class="col-12 col-sm-6 col-md-4 grid-item-wrapper"
                                            data-name="<?php echo e(strtolower($membership->name)); ?>">
                                            <div class="item-card border rounded cursor-pointer transition-all h-100"
                                                data-type="membership" data-id="<?php echo e($membership->id); ?>"
                                                data-name="<?php echo e($membership->name); ?>" data-price="<?php echo e($membershipPrice); ?>">
                                                <div class="fw-bold text-dark text-truncate w-100" style="font-size: 0.825rem;"
                                                    title="<?php echo e($membership->name); ?>">
                                                    <?php echo e($membership->name); ?>

                                                </div>
                                                <div class="text-purple-800 fw-bold text-xs mt-1">
                                                    <?php echo e(format_currency($membershipPrice)); ?>
                        ...
                        <!-- Unified Cart Table -->
                        <div class="table-responsive mt-2 border rounded shadow-sm"
                            ...
                            <table class="table table-sm table-hover mb-0" id="unifiedCartTable">
                                <thead class="table-light">
                                    <tr class="text-uppercase small text-muted">
                                        ...
                                        <th class="text-center py-2 fw-semibold">Barber</th>
                                    ...
                                    <select class="form-select" id="customerSelect">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer['id']); ?>" data-name="<?php echo e($customer['name']); ?>"
                                                data-phone="<?php echo e($customer['phone']); ?>" data-email="<?php echo e($customer['email']); ?>">
                                                <?php echo e($customer['text']); ?>
                                    ...
                                    <div>
                                        ...
                                        <div id="membershipInfo" class="mt-1 d-none">
                                            <small class="badge bg-success text-white">
                                                <i class="fas fa-star me-1"></i>Membership: <span
                                                    id="membershipName"></span>
                        ...
                        <div class="border-top pt-2">
                            ...
                            <div class="row mb-1 align-items-center">
                                <div class="col-8">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <select class="form-select border-start-0 border-end-0" id="discountType"
                                        ...
                                        <button class="btn btn-outline-danger d-none" type="button" id="clearDiscount"
                            ...
                            <div class="row mb-1">
                                <div class="col-8"><small class="text-muted">Tax
                                        (<?php echo e(number_format($taxRate ?? 0, 2) + 0); ?>%)</small></div>
                            ...
                            <div class="row mb-1">
                                <div class="col-6">
                                    ...
                                    <input type="number" class="form-control form-control-sm py-0" style="height: 26px;"
                                        id="tipAmount" value="0" min="0" step="0.01">
                                </div>
                                ...
                                <div class="mb-2 mt-1">
                                    ...
                                    <div class="row g-1">
                                        ...
                                        <?php if($acceptOnline ?? true): ?>
                                            <div class="col-6">
                                                <input type="radio" class="btn-check" name="payment_method"
                                                    id="cartPaymentOnline" value="online" autocomplete="off">
                                        ...
                                        <div class="col-6">
                                            <input type="radio" class="btn-check" name="payment_method"
                                                id="cartPaymentOther" value="other" autocomplete="off">
                                            <label class="btn btn-outline-secondary btn-sm w-100 py-1"
                                                for="cartPaymentOther">
                                                <i class="fas fa-ellipsis-h me-1"></i>Other
                                            </label>
                                        </div>
                                        <div class="col-6">
                                            <input type="radio" class="btn-check" name="payment_method"
                                                id="cartPaymentMixed" value="mixed" autocomplete="off">
                                        ...
                                        <div class="col-6" style="display: none;">
                                            <input type="radio" class="btn-check" name="payment_method"
                                                id="cartPaymentPackage" value="package" autocomplete="off">
                                            <label class="btn btn-outline-primary btn-sm w-100 py-1"
                                                for="cartPaymentPackage">
                            ...
                            <div id="paymentDetailsSection">
                                <div class="row mb-2">
                                    <div class="col-6">
                                        ...
                                        <input type="number" class="form-control form-control-sm py-0" style="height: 26px;"
                                            id="amountReceived" step="0.01" min="0">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label small mb-0">Change</label>
                                        <input type="text" class="form-control form-control-sm py-0" style="height: 26px;"
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text py-0"><i
                                                        class="fas fa-money-bill-wave"></i></span>
                                                <input type="number" class="form-control split-input py-0"
                                                    style="height: 26px;" id="splitCash" placeholder="0.00" min="0"
                                                    step="0.01">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control split-input py-0"
                                                    style="height: 26px;" id="splitCard" placeholder="0.00" min="0"
                                                    step="0.01">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control split-input py-0"
                                                    style="height: 26px;" id="splitOnline" placeholder="0.00" min="0"
                                                    step="0.01">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" class="form-control split-input py-0"
                                                    style="height: 26px;" id="splitOther" placeholder="0.00" min="0"
                                                    step="0.01">
                                            </div>
                                        </div>
                                    </div>
...
<?php endif; ?>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 420px;">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-body text-center px-4 py-4">
                    ...
                    <p class="text-muted mb-0 small" id="resetModalMessage">Are you sure you want to reset the terminal for
                        a new sale?</p>
                </div>
                ...
                <div class="modal-footer border-0 px-4 pb-4 pt-0">
                    <div class="d-flex gap-2 w-100">
                        ...
                        <button type="button" class="btn btn-danger flex-grow-1 fw-semibold py-2 shadow-sm"
                            id="confirmResetBtn"
                            style="border-radius: 8px; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); border: none;">
                            Yes, Reset
                        </button>
                    </div>
                </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            const salonData = <?php echo json_encode($salonData, 15, 512) ?>;
            ...
            $(document).ready(function () {
                // Staff list for JS
                const staffList = <?php echo json_encode($staff->map(function ($staff) {
                    return [
                        'id' => $staff->id, 'name' => $staff->name, 'service_ids' => $staff->services->pluck('id')->toArray()
                    ];
                })) ?>;
                ...
                const taxRate = <?php echo e(number_format($taxRate ?? 0, 2) + 0); ?>;
                const taxEnabledPos = <?php echo json_encode($taxEnabledPos ?? false, 15, 512) ?>;
                const taxEnabledServices = <?php echo json_encode($taxEnabledServices ?? false, 15, 512) ?>;

                const currencySymbol = <?php echo json_encode($currencySymbol ?? '$'); ?>;
                const posReceiptArabicEnabled = <?php echo json_encode($posReceiptArabic ?? true, 15, 512) ?>;
                ...
                $('#customerSelect').select2({
                    ...
                    allowClear: true,
                    width: '100%',
                    data: <?php echo json_encode($customersJson); ?>,
                    ajax: {
                        url: '<?php echo e(route("admin.pos.customer.mobile.search")); ?>',
                        dataType: 'json',
                        delay: 300,
                ...
                // POS Action Buttons Toggling (Switch visible Grid section)
                $('#posActionButtons button').on('click', function () {
                    ...
                    // Show selected grid section, hide others
                    $('.grid-section').addClass('d-none');
                    $(`#${type}GridSection`).removeClass('d-none');
                });

                // Click item card to add to cart directly
                $(document).on('click', '.item-card', function () {
                    ...
                    if (type === 'service') {
                        if (typeof customerPackageBalances !== 'undefined' && customerPackageBalances.length > 0) {
                ...
                // Live search grid filter
                $('#gridFilterInput').on('input', function () {
                ...
                function fetchBookingDetails(params) {
                    $.ajax({
                        url: '<?php echo e(route("admin.pos.booking-details")); ?>',
                        method: 'GET',
                        data: params,
                        success: function (response) {
                ...
                $(document).ready(function () {
                    ...
                    // Toggle service card selection
                    $(document).on('click', '.service-card', function (e) {
                        if ($(e.target).is('input')) return;

                        const $card = $(this);
                        const $checkbox = $card.find('.service-checkbox');
                        ...
                        if (isChecked) {
                            ...
                            $card.find('.selected-checkmark').addClass('d-none');
                        }
                    });
                ...
                function processSale(confirmUnpaid = false) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("admin.pos.store")); ?>',
                        method: 'POST',
                ...
                function showReceipt(sale, receiptUrl = null) {
                    ...
                    const cashierName = sale.employee ? sale.employee.name : "<?php echo e(auth()->user()->name); ?>";
                    ...
                    $('#printReceiptBtn').off('click').on('click', function () {
                        const finalReceiptUrl = receiptUrl || "<?php echo e(route('admin.pos.receipt', ['sale' => ':id'])); ?>".replace(':id', sale.id);
                        window.open(finalReceiptUrl, '_blank');
                    });

                    $('#printArabicReceiptBtn').off('click').on('click', function () {
                        const finalArabicReceiptUrl = "<?php echo e(route('admin.pos.receipt.arabic', ['sale' => ':id'])); ?>".replace(':id', sale.id);
                ...
                function checkCustomerMembership(customerId) {
                    $.ajax({
                        url: '<?php echo e(route("admin.pos.customer.membership", ":id")); ?>'.replace(':id', customerId),
                        method: 'GET',
                        success: function (response) {
                ...
                function fetchCustomerPackageBalances(customerId) {
                    ...
                    const url = '<?php echo e(route("admin.bookings.customer-package-balances", ":id")); ?>'.replace(':id', customerId);
                ...
                function fetchAndAddPackageServices(packageId, quantity) {
                    $.ajax({
                        url: "<?php echo e(route('admin.pos.package.services', ':id')); ?>".replace(':id', packageId),
                        method: 'GET',
                        success: function (response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\pos\barber.blade.php ENDPATH**/ ?>