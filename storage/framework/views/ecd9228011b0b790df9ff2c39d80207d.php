                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder mb-0">
                                        <?php echo e(currency_symbol()); ?><?php echo e(number_format($stats['revenue'], 2)); ?>
                        ...
                        <div class="px-4">
                            <ul class="nav nav-pills nav-fill p-1 bg-light rounded-4 mb-4" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active rounded-4 py-2" id="pills-today-tab"
                                        ...
                                        <i class="fas fa-calendar-day me-2"></i>Today (<?php echo e($todayBookings->count()); ?>)
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link rounded-4 py-2" id="pills-ongoing-tab" data-bs-toggle="pill"
                                        ...
                                        <i class="fas fa-spinner fa-spin me-2"></i>Active (<?php echo e($ongoingBookings->count()); ?>)
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link rounded-4 py-2" id="pills-future-tab" data-bs-toggle="pill"
                                        ...
                                        <i class="fas fa-calendar-plus me-2"></i>Future (<?php echo e($futureBookings->count()); ?>)
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-today" role="tabpanel">
                                    <?php echo $__env->make('admin.bookings.partials.booking_table', ['bookings' => $todayBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                                <div class="tab-pane fade" id="pills-ongoing" role="tabpanel">
                                    <?php echo $__env->make('admin.bookings.partials.booking_table', ['bookings' => $ongoingBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                                <div class="tab-pane fade" id="pills-future" role="tabpanel">
                                    <?php echo $__env->make('admin.bookings.partials.booking_table', ['bookings' => $futureBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\bookings\ongoing.blade.php ENDPATH**/ ?>