                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 p-md-5">
                            <form method="POST" action="<?php echo e(route('customer.appointments.store')); ?>" id="bookingForm">
                                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <strong id="servicePrice"><?php echo e(currency_symbol()); ?>0.00</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function fetchAvailableSlots(date, serviceId) {
                    fetch(`<?php echo e(route('customer.api.appointments.available-slots')); ?>?date=${date}&service_id=${serviceId}`)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\customer\appointments\create.blade.php ENDPATH**/ ?>