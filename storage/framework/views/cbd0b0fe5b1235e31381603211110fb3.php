...
<div class="container-fluid py-4">
    ...
    <form action="<?php echo e(route('admin.commissions.update', $profile)); ?>" method="POST" id="commissionForm">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check form-check-inline me-4">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_target" value="by_target" <?php echo e(old('type', $profile->type) == 'by_target' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input type-radio" type="radio" name="type" id="type_item" value="by_item" <?php echo e(old('type', $profile->type) == 'by_item' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="name" name="name" value="<?php echo e(old('name', $profile->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="daily" <?php echo e(old('calculation_interval', $profile->calculation_interval) == 'daily' ? 'selected' : ''); ?>>Daily</option>
                                    <option value="weekly" <?php echo e(old('calculation_interval', $profile->calculation_interval) == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                                    <option value="monthly" <?php echo e(old('calculation_interval', $profile->calculation_interval) == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="all" <?php echo e(old('qualifying_item', $profile->qualifying_item) == 'all' ? 'selected' : ''); ?>>All Items</option>
                                    <option value="service" <?php echo e(old('qualifying_item', $profile->qualifying_item) == 'service' ? 'selected' : ''); ?>>Services Only</option>
                                    <option value="product" <?php echo e(old('qualifying_item', $profile->qualifying_item) == 'product' ? 'selected' : ''); ?>>Products Only</option>
                                    <option value="membership" <?php echo e(old('qualifying_item', $profile->qualifying_item) == 'membership' ? 'selected' : ''); ?>>Memberships Only</option>
                                    <option value="package" <?php echo e(old('qualifying_item', $profile->qualifying_item) == 'package' ? 'selected' : ''); ?>>Packages Only</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="checkbox" name="include_tax" 
                                           id="include_tax" value="1" <?php echo e(old('include_tax', $profile->include_tax) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check mb-2" id="cascadeCol">
                                    <input class="form-check-input" type="checkbox" name="is_cascade" 
                                           id="is_cascade" value="1" <?php echo e(old('is_cascade', $profile->is_cascade) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_active" 
                                           id="is_active" value="1" <?php echo e(old('is_active', $profile->is_active) ? 'checked' : ''); ?>>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <p class="mb-2"><strong>Assigned Staff:</strong> <?php echo e($profile->staff()->count()); ?></p>
                        <p class="mb-2"><strong>Created:</strong> <?php echo e(format_date($profile->created_at)); ?></p>
                        <p class="mb-0"><strong>Last Updated:</strong> <?php echo e(format_date($profile->updated_at)); ?></p>
                    </div>
                </div>
...
const existingRules = <?php echo json_encode($profile->rules, 15, 512) ?>;
const profileType = '<?php echo e($profile->type); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\commissions\edit.blade.php ENDPATH**/ ?>