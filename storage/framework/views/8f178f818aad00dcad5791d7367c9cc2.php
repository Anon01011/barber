    ...
    <div class="error-container">
        <div class="glass-card text-center">
            ...
            <p class="error-message">
                <?php echo e($exception->getMessage() ?: 'This feature is not available in your current plan. Please upgrade to access this feature.'); ?>

            </p>

            <!-- Current Plan Info -->
            <?php if(auth()->check() && auth()->user()->salon && auth()->user()->salon->activeSubscription): ?>
                <?php
                ...
                <div class="plan-badge">
                    ...
                    <span>Current Plan: <?php echo e($plan->name); ?></span>
                </div>
            <?php endif; ?>

            <!-- Action Buttons -->
            <div class="d-flex gap-2 justify-content-center flex-wrap mb-3">
                <?php if(auth()->check() && auth()->user()->hasRole('salon_admin')): ?>
                    <?php
                        $salonSlug = auth()->user()->salon ? auth()->user()->salon->slug : null;
                    ?>
                    <?php if($salonSlug): ?>
                        <a href="<?php echo e(route('admin.saas.subscription.index', ['salon_slug' => $salonSlug])); ?>" class="btn-custom btn-primary-custom">
                ...
                <?php if(auth()->check()): ?>
                    ...
                    <a href="<?php echo e($dashboardUrl); ?>" class="btn-custom btn-secondary-custom">
                        <i class="fas fa-home"></i>
                        Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('home')); ?>" class="btn-custom btn-secondary-custom">
                        <i class="fas fa-home"></i>
                        Home
                    </a>
                <?php endif; ?>
...
<?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\errors\403.blade.php ENDPATH**/ ?>