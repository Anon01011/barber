...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4 align-items-center">
            <div class="col">
                <h1 class="h3 mb-1 fw-bold text-gray-800">Edit Package</h1>
                <p class="text-muted mb-0">Update package details, pricing, and included services.</p>
            </div>
            <div class="col-auto">
        ...
        <form action="<?php echo e(route('admin.packages.update', $package->id)); ?>" method="POST" class="needs-validation" novalidate>
            <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg bg-light border-0" id="name"
                                    name="name" value="<?php echo e(old('name', $package->name)); ?>"
                                    placeholder="e.g., Summer Glow Package" required>
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="form-check custom-card-radio flex-fill">
                                            <input class="form-check-input" type="radio" name="type" id="fixed"
                                                value="fixed" <?php echo e(old('type', $package->type) == 'fixed' ? 'checked' : ''); ?>
                                        ...
                                        <div class="form-check custom-card-radio flex-fill">
                                            <input class="form-check-input" type="radio" name="type" id="customizable"
                                                value="customizable" <?php echo e(old('type', $package->type) == 'customizable' ? 'checked' : ''); ?> required>
                                            <label
                                                class="form-check-label p-3 border rounded-3 w-100 d-flex align-items-center cursor-pointer transition-all"
                                                for="customizable">
                                                <div
                            ...
                            <div class="mb-4" id="service_limit_container"
                                style="<?php echo e($package->type == 'customizable' ? '' : 'display: none;'); ?>">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control form-control-lg bg-light border-0"
                                        ...
                                        value="<?php echo e(old('service_limit', $package->service_limit)); ?>"
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control bg-light border-0" id="description" name="description"
                                    rows="3"
                                    placeholder="Describe what's included in this package..."><?php echo e(old('description', $package->description)); ?></textarea>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-lg bg-light border-0"
                                            ...
                                            value="<?php echo e(old('validity_value', $package->validity_value)); ?>" min="1" required>
                                        <select class="form-select form-select-lg bg-light border-0" id="validity_unit"
                                            name="validity_unit" style="max-width: 120px;">
                                            <option value="days" <?php echo e(old('validity_unit', $package->validity_unit) == 'days' ? 'selected' : ''); ?>>Days</option>
                                            <option value="weeks" <?php echo e(old('validity_unit', $package->validity_unit) == 'weeks' ? 'selected' : ''); ?>>Weeks</option>
                                            <option value="months" <?php echo e(old('validity_unit', $package->validity_unit) == 'months' ? 'selected' : ''); ?>>Months</option>
                                            <option value="years" <?php echo e(old('validity_unit', $package->validity_unit) == 'years' ? 'selected' : ''); ?>>Years</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-switch p-3 bg-light rounded-3 border-0">
                                        <input class="form-check-input ms-0 me-3" type="checkbox" id="is_active"
                                            name="is_active" value="1" <?php echo e(old('is_active', $package->is_active) ? 'checked' : ''); ?> style="width: 3em; height: 1.5em;">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden">
                            ...
                            <div class="card-body p-0">
                                <div id="selected-services-list" class="custom-scrollbar"
                                    ...
                                    <!-- Empty State -->
                                    <div id="empty-state" class="text-center py-5 px-4" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="number" step="0.01" class="form-control border-0 bg-light fw-bold"
                                            ...
                                            value="<?php echo e(old('special_price', $package->special_price)); ?>" placeholder="0.00">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border-0 bg-light" id="tax_rate" name="tax_rate" required>
                                        ...
                                        <?php $__currentLoopData = $taxRates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($rate); ?>" <?php echo e(old('tax_rate', $package->tax_rate) == $rate ? 'selected' : ''); ?>><?php echo e($rate); ?>%</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>

                                <input type="hidden" id="price" name="price" value="<?php echo e($package->price); ?>">
                            </div>
                        </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function addService(id, name, price, formattedPrice, quantity = 1) {
                    ...
                    const service = { id, name, price, formattedPrice, quantity: parseInt(quantity) };
                ...
                // Initialize Data
                const existingServices = <?php echo json_encode($package->services, 15, 512) ?>;
                existingServices.forEach(s => {
                    addService(
                        String(s.id),
                        s.name,
                        parseFloat(s.price),
                        "<?php echo e(currency_symbol()); ?>" + parseFloat(s.price).toFixed(2),
                        s.pivot.quantity
                    );
                });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\packages\edit.blade.php ENDPATH**/ ?>