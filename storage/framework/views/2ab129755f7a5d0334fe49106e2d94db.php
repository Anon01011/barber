...
<?php $__env->startSection('content'); ?>
    <div class="template-editor-container py-3">
        <form action="<?php echo e(route('admin.saas.settings.email-templates.update', $template->type)); ?>" method="POST"
            id="templateForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="editor-wrapper">
                ...
                <div class="editor-toolbar">
                    <div class="d-flex align-items-center">
                        <a href="<?php echo e(route('admin.saas.settings.email-templates')); ?>"
                            class="btn btn-sm btn-outline-secondary me-3 border-0">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <div>
                            <h6 class="fw-bold mb-0 text-dark"><?php echo e(ucwords(str_replace('_', ' ', $template->type))); ?></h6>
                            <span
                                class="badge <?php echo e($template->is_active ? 'bg-success' : 'bg-secondary'); ?> bg-opacity-10 <?php echo e($template->is_active ? 'text-success' : 'text-secondary'); ?> rounded-pill"
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="form-check form-switch me-2" title="Enable/Disable Template">
                            <input class="form-check-input" type="checkbox" id="isActive" name="is_active" value="1" <?php echo e($template->is_active ? 'checked' : ''); ?>>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-3">
                                ...
                                <input type="text" name="subject" id="templateSubject"
                                    ...
                                    value="<?php echo e(old('subject', $template->subject)); ?>" placeholder="Email Subject Line"
                                    required>
                            </div>
                        ...
                        <div class="variable-list">
                            ...
                            <?php if(!empty($template->variables)): ?>
                                <?php $__currentLoopData = $template->variables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="variable-item copy-variable" data-variable="<?php echo e($variableName); ?>">
                                        <span class="variable-code"><?php echo e($variableName); ?></span>
                                        <span class="text-secondary small"><?php echo e($description); ?></span>
                                    </div>
        ...
        <?php if($template->salon_id): ?>
            <form id="deleteForm" action="<?php echo e(route('admin.saas.settings.email-templates.delete', $template->type)); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const sampleData = {
            ...
            '{{salon_name}}': '<?php echo e(auth()->user()->salon->name ?? "Luxe Salon"); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\saas\settings\templates\edit.blade.php ENDPATH**/ ?>