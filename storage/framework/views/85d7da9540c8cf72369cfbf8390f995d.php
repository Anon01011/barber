            ...
            <div class="mail-card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="mail_driver" class="form-select <?php $__errorArgs = ['mail_driver'];
...
unset($__errorArgs, $__bag); ?>"
                            id="mail_driver">
                            <option value="smtp" <?php echo e(old('mail_driver', $settings['mail_driver'] ?? ($salon->mail_driver ?? 'smtp')) == 'smtp' ? 'selected' : ''); ?>>SMTP (Recommended)</option>
                            <option value="sendmail" <?php echo e(old('mail_driver', $settings['mail_driver'] ?? ($salon->mail_driver ?? 'smtp')) == 'sendmail' ? 'selected' : ''); ?>>Sendmail</option>
                            <option value="log" <?php echo e(old('mail_driver', $settings['mail_driver'] ?? ($salon->mail_driver ?? 'smtp')) == 'log' ? 'selected' : ''); ?>>Log File (Testing)</option>
                        </select>
                    </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('mail_host', $settings['mail_host'] ?? ($salon->mail_host ?? ''))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('mail_port', $settings['mail_port'] ?? ($salon->mail_port ?? 587))); ?>"
                            placeholder="587">
                    </div>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="tls" <?php echo e(old('mail_encryption', $settings['mail_encryption'] ?? ($salon->mail_encryption ?? 'tls')) == 'tls' ? 'selected' : ''); ?>>TLS (Recommended)
                            </option>
                            <option value="ssl" <?php echo e(old('mail_encryption', $settings['mail_encryption'] ?? ($salon->mail_encryption ?? 'tls')) == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                            <option value="" <?php echo e(old('mail_encryption', $settings['mail_encryption'] ?? ($salon->mail_encryption ?? 'tls')) == '' ? 'selected' : ''); ?>>None</option>
                        </select>
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('mail_username', $settings['mail_username'] ?? ($salon->mail_username ?? ''))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('mail_from_name', $settings['mail_from_name'] ?? ($salon->mail_from_name ?? ''))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('mail_from_address', $settings['mail_from_address'] ?? ($salon->mail_from_address ?? ''))); ?>"
        ...
        <div class="mail-settings-card mt-4">
            ...
            <div class="mail-card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('admin.saas.settings.email-templates')); ?>" class="btn btn-primary shadow-sm">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (testBtn) {
                testBtn.addEventListener('click', function () {
                    ...
                    fetch('<?php echo e(route("admin.saas.settings.mail.test")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php $__env->stopPush(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\admin\settings\partials\mail.blade.php ENDPATH**/ ?>