<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><?php echo e(__('Appointment Calendar')); ?></div>
                                                ...
                                                <select name="service_id" id="service_id" class="form-control" required>
                                                    ...
                                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($service->id); ?>"><?php echo e($service->name); ?> -
                                                            $ <?php echo e($service->price); ?></option>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const salonTimezone = '<?php echo e($settings->get("timezone", "UTC")); ?>';
                ...
                window.calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    slotMinTime: '<?php echo e($settings->get("working_hours_start", "08:00")); ?>',
                    slotMaxTime: '<?php echo e($settings->get("working_hours_end", "20:00")); ?>',
                    businessHours: {
                        daysOfWeek: [0, 1, 2, 3, 4, 5, 6],
                        startTime: '<?php echo e($settings->get("working_hours_start", "08:00")); ?>',
                        endTime: '<?php echo e($settings->get("working_hours_end", "20:00")); ?>',
                    },
                    events: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\customer\appointments\calendar.blade.php ENDPATH**/ ?>