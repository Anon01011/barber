                ...
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-3">View the total value of your inventory based on purchase and
                            selling prices.</p>
                        <a href="<?php echo e(route('admin.inventory.reports.stock-valuation')); ?>"
                ...
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-3">Track all stock movements including purchases, adjustments, and
                            usage.</p>
                        <a href="<?php echo e(route('admin.inventory.reports.stock-movement')); ?>"
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.inventory.reports.dead-stock')); ?>" class="btn btn-warning btn-sm w-100">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.inventory.reports.profit-analysis')); ?>" class="btn btn-info btn-sm w-100">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.inventory.reports.low-stock')); ?>" class="btn btn-danger btn-sm w-100">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.inventory.alerts.index')); ?>" class="btn btn-secondary btn-sm w-100">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\inventory\reports\index.blade.php ENDPATH**/ ?>