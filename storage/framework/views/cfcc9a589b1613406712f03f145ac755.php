            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-md-end gap-2">
                    <?php if(optional(auth()->user()->salon)->business_type === 'both'): ?>
                        <a href="<?php echo e(route('admin.pos.index', ['view' => 'barber'])); ?>" class="btn btn-sm btn-outline-warning">
                                            ...
                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <div class="form-check py-1">
                                                        <input class="form-check-input service-checkbox" type="checkbox" value="<?php echo e($service->id); ?>" id="service_cb_<?php echo e($service->id); ?>" data-name="<?php echo e($service->name); ?>" data-price="<?php echo e($service->price); ?>">
                                                        <label class="form-check-label small w-100" style="cursor:pointer;" for="service_cb_<?php echo e($service->id); ?>">
                                                            <?php echo e($service->name); ?> (<?php echo e(format_currency($service->price)); ?>)
                                                        </label>
                                                    </div>
                                                </li>
                                    ...
                                    <select class="form-select form-select-sm product-select" id="addProductSelect">
                                        ...
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>"
                                                ...
                                                data-stock="<?php echo e($product->quantity_in_stock); ?>" <?php echo e($product->quantity_in_stock <= 0 ? 'disabled' : ''); ?>>
                                                <?php echo e($product->name); ?> (<?php echo e(format_currency($product->selling_price)); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select form-select-sm" id="addPackageSelect">
                                        ...
                                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($package->id); ?>" data-name="<?php echo e($package->name); ?>"
                                                data-price="<?php echo e($package->price); ?>"
                                                data-service-limit="<?php echo e($package->service_limit ?? ''); ?>">
                                                <?php echo e($package->name); ?> (<?php echo e(format_currency($package->price)); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-select-sm" id="addMembershipSelect">
                                        ...
                                        <?php $__currentLoopData = $memberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($membership->id); ?>" data-name="<?php echo e($membership->name); ?>"
                                                data-price="<?php echo e($membership->calculateTotalMembershipPrice()); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\pos\index.blade.php ENDPATH**/ ?>