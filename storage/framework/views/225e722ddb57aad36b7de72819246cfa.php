                                            ...
                                            <tr>
                                                <td class="px-4 py-3">
                                                    <div class="d-flex flex-column">
                                                        <span class="fw-bold text-dark"><?php echo e($appointment->start_time->format('h:i A')); ?></span>
                                                        <span class="text-muted small"><?php echo e($appointment->start_time->format('M d')); ?></span>
                                                    </div>
                                                </td>
                                                <td class="py-3">
                                                    <div class="d-flex align-items-center">
                                                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($appointment->customer->name)); ?>&background=random&size=32"
                                                            alt="<?php echo e($appointment->customer->name); ?>" class="rounded-circle me-2 shadow-sm"
                                                            style="width: 32px; height: 32px;">
                                                        <div>
                                                            <div class="fw-bold text-dark"><?php echo e($appointment->customer->name); ?></div>
                                                            <?php if($appointment->customer->phone): ?>
                                                                <div class="text-muted small"><i class="fas fa-phone-alt me-1 fa-xs"></i><?php echo e($appointment->customer->phone); ?></div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="py-3">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <?php endif; ?>
                                                        <span class="text-muted small mt-1"><?php echo e(currency_symbol()); ?> <?php echo e(number_format($appointment->amount, 2)); ?> • <?php echo e($appointment->service->duration); ?> mins</span>
                                                    </div>
                                                </td>
                                                <td class="py-3">
                                                    <?php
                                                    ...
                                                    ?>
                                                    <span class="badge bg-<?php echo e($statusClass); ?>-subtle text-<?php echo e($statusClass); ?> border border-<?php echo e($statusClass); ?>-subtle rounded-pill">
                                                ...
                                                <td class="py-3 text-end px-4">
                                                    ...
                                                    <?php if($appointment->status === 'confirmed'): ?>
                                                        <button type="button" class="btn btn-sm btn-light text-success hover-shadow ms-1"
                                                            onclick="completeAppointment(<?php echo e($appointment->id); ?>)" title="Mark Completed">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FSQTAR-PROJECTS\salon-multi-options\resources\views\staff\appointments\today.blade.php ENDPATH**/ ?>